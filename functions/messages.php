...
function message($type, $text, $icon = false, $action = array(), $translate = true, $val = false) {
    ...
    switch ($type) {
        ...
        case "Info":
            ...
            $m = '<div class="alert alert-info" role="alert">' . $icon_show . ' <b>' . _tr('Info') . ':</b> ' . (($text_translated)) . ' ' . $link_action . '</div>';
            break;
        ...
        case "error":
            ...
            $m = '<div class="alert alert-warning" role="alert">' . $icon_show . ' <b>' . _tr('Warning') . ':</b> ' . (($text_translated)) . ' ' . $link_action . '</div>';
            break;

        case "danger":
        case "Danger":
            $icon_show = "<span class='glyphicon glyphicon-alert'></span>";
            $m = '<div class="alert alert-danger" role="alert">' . $icon_show . ' <b>' . _tr('Danger') . ':</b> ' . (($text_translated)) . ' ' . $link_action . '</div>';
            break;
        ...
        case "Info":
            $icon_show = "<span class='glyphicon glyphicon-lamp'></span>";
            $m = '<div class="alert alert-danger" role="alert">' . $icon_show . ' <b>' . _tr('Info') . ':</b> ' . (($text_translated)) . ' ' . $link_action . '</div>';
            break;
    }
