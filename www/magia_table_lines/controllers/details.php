...
# 
if (! magia_table_lines_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $magia_table_lines = new Magia_table_lines();
    $magia_table_lines->setMagia_table_lines($id);

    include view("magia_table_lines", "details");
