<form action="index.php" method="post" >
    ...
    <input type="hidden" name="a" value="export_pdf_r2"> 
    ...
    /*    <div class="form-group">
      ...
      <p><span class="glyphicon glyphicon-paperclip"></span> <a href="index.php?c=invoices&a=export_pdf_r2&way=web&id=<?php echo $id; ?>" target="new"><?php _t("Reminder_2.pdf"); ?></a></p>
      </div>
     */
    ?>
