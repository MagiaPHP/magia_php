...
<?php
$colsToShow = json_decode(_options_option('invoices_index_cols_to_show'), true);
?>
...
<div class="shadow-container">
    ...
    <table class="table table-striped table-condensed">
        ...
        <thead>
            <tr class="">
                <td></td>
                <?php invoices_index_generate_column_headers($colsToShow); ?>
            </tr>
        </thead>
            ...
            if (!isset($invoices)) {
                ...
                foreach ($invoices as $invoice) {
                    ...
                    if ($month_actual != $month) {
                        ...
                        ?> 
                        <tr  class='success'>
                            <td colspan="<?php echo (count($colsToShow) + 1) ?? 1; ?>">
                                <b>
                    ...
                    <tr>  
                        ...
                        <?php
                        invoices_index_generate_column_body_td($invoice, $colsToShow);
                        ?>
                        ...
                        <?php /**
                          ...
                          <td>
                          <a class="btn btn-sm btn-primary" href="index.php?c=invoices&a=details_payement&id=<?php echo "$invoice[id]"; ?>">
                          <span class="glyphicon glyphicon-shopping-cart"></span> <?php // _t("Pay");    ?>
                          </a>
                          </td>
