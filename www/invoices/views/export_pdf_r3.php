...
include pdf_template("reminders3");

$pdf = new PDF_REMINDERS3();

$pdf->setPdfInvoice($id);
$pdf->setDocModele(_options_option('doc_model'));
$pdf->setDoc('reminders3');
$pdf->setLang($lang);
...
switch ($way) {
    case "pdf":
        $pdf->Output("Rappel_$id" . ".pdf", "D");
        break;

    case "web":
        $pdf->Output("Rappel_$id" . ".pdf", "I");
        break;
    ...
    case "email":
        ...
        $reminder_percent = (_options_option('config_invoices_r3')) ? _options_option('config_invoices_r3') : 0;
        // registro el rappel,listo para ser agregado en la proxima factura
        reminders_invoices_add(null, $id, $solde, 'r3', $reminder_percent, null, 0, 0);
        ////////////////////////////////////////////////////////////////////////
