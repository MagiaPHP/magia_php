...
include pdf_template("reminders2");

$pdf = new PDF_REMINDERS2();

$pdf->setPdfInvoice($id);
$pdf->setDocModele(_options_option('doc_model'));
$pdf->setDoc('reminders2');
$pdf->setLang($lang);
...
switch ($way) {
    ...
    case "email":
        ...
        $reminder_percent = (_options_option('config_invoices_r2')) ? _options_option('config_invoices_r2') : 0;
        // registro el rappel,listo para ser agregado en la proxima factura
        reminders_invoices_add(null, $id, $solde, 'r2', $reminder_percent, null, 0, 0);
        ////////////////////////////////////////////////////////////////////////
