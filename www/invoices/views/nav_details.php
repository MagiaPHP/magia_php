    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
                ...
                <?php echo ( _options_option('config_menus_debug') ) ? _menus_get_file_name(__FILE__) : _t("Sales invoice"); ?>
                : 
                <?php echo $id; ?>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="menu_invoices_details">
            <ul class="nav navbar-nav">
                ...
                <?php
                //
                print_icon_nav("index.php?c=invoices&a=export_pdf&id=$id", invoices_field_id('client_id', $id), _tr('Print'));
                ?>
            ...
            <?php if (permissions_has_permission($u_rol, "invoices", "update")) { ?> 
                ...
                <?php if (invoices_can_be_edit($id)) { ?>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <ul>
                                            <?php
                                            foreach (invoices_why_can_not_be_edit($id) as $key => $value) {
                                                echo "<li>$value</li>";
                                            }
                                            ?>
                                        </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php
                if (
                        permissions_has_permission($u_rol, 'export', "reaaaaaaaaaaaad") &&
                        modules_field_module('status', 'export')
                ) {
                    ?>
                    <li>
                        <a href="index.php?c=invoices&a=export&id=<?php echo $id; ?>">
                            <?php _t('Export'); ?>
                        </a>
                    </li> 
                <?php } ?>
                ...
                if (
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="index.php?c=invoices&a=export_json&id=<?php echo $id; ?>">Export json</a></li>
                            <li><a href="index.php?c=invoices&a=import_json&id=<?php echo $id; ?>">Import json</a></li>
                            <li><a href="#">Another action</a></li>
                            <li><a href="#">Something else here</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="#">Separated link</a></li>
                ...
                <ul class="nav navbar-nav navbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="index.php?c=invoices&a=copy&id=<?php echo $id; ?>"><?php _t("Make a copy"); ?></a></li>
                            <?php
                            /*                            <li><a href="#">Another action</a></li>
                              <li><a href="#">Something else here</a></li>
                              <li role="separator" class="divider"></li>
