<div>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Invoice</a></li>
...
<Invoice>
    ...
    <cac:InvoiceLine>
        ...
        <div role="tabpanel" class="tab-pane" id="profile">
            <iframe width="100%" height="5000" src="www/invoices/example.xml"></iframe>
        </div>
        <div role="tabpanel" class="tab-pane" id="messages">
            <iframe width="100%" height="5000" src="www/invoices/UBL-Invoice-2.1-Example.xml"></iframe>
        </div>
        <div role="tabpanel" class="tab-pane" id="settings">
            <iframe width="100%" height="5000" src="http://docs.oasis-open.org/ubl/os-UBL-2.1/xsd/maindoc/UBL-Invoice-2.1.xsd"></iframe>            
        </div>
    </div>
