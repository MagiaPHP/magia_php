...
$id = invoices_next_number();
$office_id = (isset($_REQUEST["office_id"]) && $_REQUEST["office_id"] != "" ) ? clean($_REQUEST["office_id"]) : 1022;

$original_id = (isset($_REQUEST["original_id"]) && $_REQUEST["original_id"] != "" ) ? clean($_REQUEST["original_id"]) : null;
...
// en copy cojemos de la factura 
//$client_id = (isset($_REQUEST["client_id"])) ? clean($_REQUEST["client_id"]) : null;
$client_id = invoices_field_id('client_id', $original_id);
...
//        }
        ...
        invoices_copy_items_to_invoice_items($original_id, $lastInsertId);
        ...
        //$c , $a , 
        $w = null;
        $description = "Make a copy from invoice: [$original_id] new invoice [$lastInsertId]";
        $doc_id = $id;
        $crud = "create";
        $error = null;
