...
//if ( addresses_field_id("contact_id" , $new_adress_id) != invoices_field_id("client_id" , $id) ) {
...
if (!$error) {
    ...
    invoices_update_billing_address($id, $new_address_json);
    ...
    //$c , $a , 
    $w = null;
    $description = "Change billing address invoice: $id <br>New address: [$new_adress_id]";
    $doc_id = $id;
    $crud = "update";
    $error = null;
    ...
    header("Location: index.php?c=invoices&a=edit&id=$id#1");
} else {
