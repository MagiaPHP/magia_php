...
# F O R M A T O
#
if (! veh_vehicle_management_is_id($id)) {
...
# 
if (! veh_vehicle_management_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $veh_vehicle_management = new Veh_vehicle_management();
    $veh_vehicle_management->setVeh_vehicle_management($id);

    include view("veh_vehicle_management", "details");
