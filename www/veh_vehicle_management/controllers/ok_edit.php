...
if (! $error ) {
    ...
    veh_vehicle_management_edit(
        $id ,  $vehicle_id ,  $maintenance_type ,  $description ,  $date ,  $cost ,  $mileage ,  $next_due_date    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicle_management&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
