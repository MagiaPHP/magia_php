...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="requests_limit" class="form-control" id="requests_limit" placeholder="requests_limit" value="100" >
        </div>	
    </div>
    <?php # /requests_limit ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="limit_period" class="form-control" id="limit_period" placeholder="limit_period" value="3600" >
        </div>	
    </div>
    <?php # /limit_period ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="last_request" class="form-control" id="last_request" placeholder="last_request" value="current_timestamp()" >
        </div>	
    </div>
    <?php # /last_request ?>
