...
# 
if (! banks_lines_tmp_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $banks_lines_tmp = new Banks_lines_tmp();
    $banks_lines_tmp->setBanks_lines_tmp($id);

    include view("banks_lines_tmp", "details");
