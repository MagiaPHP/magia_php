...
if (!$error) {
    $lastInsertId = hr_employee_money_advance_add(
        $employee_id ,  $date ,  $value ,  $way ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_employee_money_advance&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
