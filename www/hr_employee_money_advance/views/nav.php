  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <a class="navbar-brand" href="index.php?c=hr_employee_money_advance">
            ...
            <?php echo ( _options_option("config_menus_debug") ) ? _menus_get_file_name(__FILE__) : _t("Hr employee money advance"); ?>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <?php // include view("hr_employee_money_advance", "form_search"   , $arg = ["redi" => 1]) ?>
            ...
            $menu_items = _menus_list_by_location_without_father("hr_employee_money_advance_nav");
            ?>
                ...
                <?php if (!empty($menu_items)): ?>
                    <?php foreach ($menu_items as $item): ?>
                        <?php if (_menus_can_show($item["controller"])): ?>
                            <li>
                                <?= _menus_dropdown_create_html("hr_employee_money_advance_nav", $item); ?>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php else: ?>
            ...
            ?>
                ...
                <?php if (permissions_has_permission($u_rol, "hr_employee_money_advance", "create")) { ?>     
                    ...
                    <button type="button" class="btn btn-primary navbar-btn navbar-right" data-toggle="modal" data-target="#hr_employee_money_advanceModal">
                        ...
                        <?php _t("New hr employee money advance"); ?>
                    </button>
