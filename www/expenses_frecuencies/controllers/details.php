...
# F O R M A T O
#
if (! expenses_frecuencies_is_id($id)) {
...
# 
if (! expenses_frecuencies_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $expenses_frecuencies = new Expenses_frecuencies();
    $expenses_frecuencies->setExpenses_frecuencies($id);

    include view("expenses_frecuencies", "details");
