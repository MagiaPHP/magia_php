...
if (!$error) {
    ...
    _options_push("expenses_frecuencies_index_cols_to_show", json_encode($data), "expenses_frecuencies");
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=expenses_frecuencies&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
