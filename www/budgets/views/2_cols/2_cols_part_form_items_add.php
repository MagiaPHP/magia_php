...
<?php if (permissions_has_permission($u_rol, 'config', 'update')) { ?>
    ...
    <button type="button" class="btn btn-xs" data-toggle="modal" data-target="#price_value_default">    
        <?php echo _options_option("config_budgets_price_value_default"); ?> : <?php _t("Default price"); ?>
    </button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php include view('budgets', 'form_price_value_default', $arg = array("redi" => 3, "id" => "$id")) ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <button type="button" class="btn btn-xs" data-toggle="modal" data-target="#vat_value_default">    
        <?php echo _options_option("config_budgets_vat_value_default"); ?>% : <?php _t("Default vat"); ?>
    </button>
    ...
    <div class="modal fade" id="vat_value_default" tabindex="-1" role="dialog" aria-labelledby="vat_value_defaultLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php _t('Add a default tva'); ?></p>
                    <?php include view('budgets', 'form_vat_value_default', $arg = array("redi" => 3, "id" => "$id")) ?>
                </div>
            </div>
        </div>
    </div>
