...
//
//            if ($line->getPrice() && ($line->getPrice() == 0 || $line->getPrice() == null ) && !_options_option('config_budgets_show_tr_no_price')) {
...
//            }
        ...
        <?php
//        vardump(_options_option('config_budgets_2_cols_table_items_tva')); 
