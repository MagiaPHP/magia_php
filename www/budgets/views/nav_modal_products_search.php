<div>
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="#materials" aria-controls="materials" role="tab" data-toggle="tab"><?php _t("Materials"); ?></a></li>
        <li role="presentation"><a href="#color" aria-controls="color" role="tab" data-toggle="tab"><?php _t("Colors"); ?></a></li>
        <li role="presentation"><a href="#marques" aria-controls="marques" role="tab" data-toggle="tab"><?php _t("Marques"); ?></a></li>
        <li role="presentation"><a href="#ecouteurs" aria-controls="ecouteurs" role="tab" data-toggle="tab"><?php _t("Ecouteurs"); ?></a></li>
        <li role="presentation"><a href="#options" aria-controls="options" role="tab" data-toggle="tab"><?php _t("Options"); ?></a></li>
        <li role="presentation"><a href="#transport" aria-controls="transport" role="tab" data-toggle="tab"><?php _t("Transports"); ?></a></li>
        <?php /*  <li role="presentation"><a href="#productosChilenos" aria-controls="productosChilenos" role="tab" data-toggle="tab"><?php _t("Productos Chilenos") ; ?></a></li> */ ?>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="transport">
            ...
            <?php if (modules_field_module('status', 'transport')) { ?>
                ...
                message('info', 'Module transport not active');
            }
            ?>
        </div>
        ...
        <?php
        /* <div role="tabpanel" class="tab-pane" id="productosChilenos">
          <h2><?php _t("P. chilenos") ; ?></h2>
          <?php include "table_productosChilenos.php" ; ?>
          </div>
         */
        ?>
