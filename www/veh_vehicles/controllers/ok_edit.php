...
if (! $error ) {
    ...
    veh_vehicles_edit(
        $id ,  $name ,  $marca ,  $modelo ,  $serie ,  $type ,  $pasangers ,  $year ,  $chasis ,  $color ,  $alto ,  $ancho ,  $largo ,  $date_buy ,  $mma ,  $towing_system ,  $towing_system_kl ,  $date_registre ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicles&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
