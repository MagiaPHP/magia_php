...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="client_id"><?php _t("Client id"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # document_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="document_id"><?php _t("Document id"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="operation_number"><?php _t("Operation number"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # created_date ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="created_date"><?php _t("Created date"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # updated_date ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="updated_date"><?php _t("Updated date"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # canceled_code ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="canceled_code"><?php _t("Canceled code"); ?></label>
        <div class="col-sm-8">
