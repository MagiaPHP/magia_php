...
# 
if (! banks_transactions_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $banks_transactions = new Banks_transactions();
    $banks_transactions->setBanks_transactions($id);

    include view("banks_transactions", "details");
