...
if (! $error ) {
    ...
    banks_transactions_edit(
        $id ,  $client_id ,  $document ,  $document_id ,  $type ,  $account_number ,  $total ,  $operation_number ,  $date ,  $ref ,  $description ,  $ce ,  $details ,  $message ,  $currency ,  $code ,  $registre_date ,  $created_date ,  $updated_date ,  $canceled_code ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=banks_transactions&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
