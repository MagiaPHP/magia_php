...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <?php # code_install ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="code_install"><?php _t("Code install"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # code_uninstall ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="code_uninstall"><?php _t("Code uninstall"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # code_check ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="code_check"><?php _t("Code check"); ?></label>
        <div class="col-sm-8">
