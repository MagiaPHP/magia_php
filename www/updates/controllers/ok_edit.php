...
if (! $error ) {
    ...
    updates_edit(
        $id ,  $code ,  $date ,  $controller ,  $version ,  $name ,  $description ,  $code_install ,  $code_uninstall ,  $code_check ,  $installed ,  $pass ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=updates&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
