...
if (!$error) {
    ...
    _options_push("products_providers_index_cols_to_show", json_encode($data), "products_providers");
    ...
    switch ($redi['redi']) {
        ...
        case 3:
            header("Location: index.php?c=products_providers&a=details&id=" . $redi['id']);
            break;        
