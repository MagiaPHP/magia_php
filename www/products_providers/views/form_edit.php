<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="provider_code" class="form-control" id="provider_code" placeholder="provider_code" value="<?php echo $products_providers->getProvider_code(); ?>" >
        </div>	
    </div>
    <?php # /provider_code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="url" class="form-control" id="url" placeholder="url - textarea" ><?php echo $products_providers->getUrl(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="price" class="form-control" id="price" placeholder="price" value="<?php echo $products_providers->getPrice(); ?>" >
        </div>	
    </div>
    <?php # /price ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="notes" class="form-control" id="notes" placeholder="notes - textarea" ><?php echo $products_providers->getNotes(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $products_providers->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
