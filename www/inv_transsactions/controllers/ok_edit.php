...
if (! $error ) {
    ...
    inv_transsactions_edit(
        $id ,  $company_id ,  $product ,  $transaction_number ,  $period ,  $start_date ,  $operation_number ,  $currency ,  $amount ,  $percentage ,  $term ,  $interest ,  $total ,  $retencion ,  $company_comission ,  $comision_bolsa ,  $total_receivable ,  $expiration_date ,  $order_by ,  $status    
        );
