...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="skill_name" class="form-control" id="skill_name" placeholder="skill_name"  value="<?php echo $cv_skills->getSkill_name(); ?>" >
        </div>	
    </div>
    <?php # /skill_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   value="<?php echo $cv_skills->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
