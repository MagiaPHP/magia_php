...
if (!$error) {
    $lastInsertId = cv_skills_add(
        $cv_id ,  $skill_name ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=cv_skills&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
