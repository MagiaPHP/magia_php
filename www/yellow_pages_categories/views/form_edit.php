...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="icon" class="form-control" id="icon" placeholder="icon"  value="<?php echo $yellow_pages_categories->getIcon(); ?>" >
        </div>	
    </div>
    <?php # /icon ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="category" class="form-control" id="category" placeholder="category"  required=""  value="<?php echo $yellow_pages_categories->getCategory(); ?>" >
        </div>	
    </div>
    <?php # /category ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $yellow_pages_categories->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
