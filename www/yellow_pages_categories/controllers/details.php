...
# F O R M A T O
#
if (! yellow_pages_categories_is_id($id)) {
...
# 
if (! yellow_pages_categories_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $yellow_pages_categories = new Yellow_pages_categories();
    $yellow_pages_categories->setYellow_pages_categories($id);

    include view("yellow_pages_categories", "details");
