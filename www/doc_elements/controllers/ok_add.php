...
if (!$error) {
    $lastInsertId = doc_elements_add(
        $element ,  $params ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=doc_elements&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
