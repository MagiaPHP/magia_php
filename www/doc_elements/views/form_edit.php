...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="element" class="form-control" id="element" placeholder="element"  required=""  value="<?php echo $doc_elements->getElement(); ?>" >
        </div>	
    </div>
    <?php # /element ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="params" class="form-control" id="params" placeholder="params - textarea" ><?php echo $doc_elements->getParams(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $doc_elements->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
