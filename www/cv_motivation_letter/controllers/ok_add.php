...
if (!$error) {
    $lastInsertId = cv_motivation_letter_add(
        $sender_name ,  $sender_email ,  $sender_phone ,  $sender_address ,  $letter_date ,  $recipient_name ,  $recipient_position ,  $recipient_company ,  $recipient_address ,  $greeting ,  $introduction ,  $body_experience ,  $body_achievements ,  $motivation ,  $closing ,  $farewell ,  $signature ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=cv_motivation_letter&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
