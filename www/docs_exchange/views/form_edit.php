<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="reciver_tva" class="form-control" id="reciver_tva" placeholder="reciver_tva" value="<?php echo $docs_exchange->getReciver_tva(); ?>" >
        </div>	
    </div>
    <?php # /reciver_tva ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="sender_name" class="form-control" id="sender_name" placeholder="sender_name" value="<?php echo $docs_exchange->getSender_name(); ?>" >
        </div>	
    </div>
    <?php # /sender_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="label" class="form-control" id="label" placeholder="label" value="<?php echo $docs_exchange->getLabel(); ?>" >
        </div>	
    </div>
    <?php # /label ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="sender_tva" class="form-control" id="sender_tva" placeholder="sender_tva" value="<?php echo $docs_exchange->getSender_tva(); ?>" >
        </div>	
    </div>
    <?php # /sender_tva ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="doc_id" class="form-control" id="doc_id" placeholder="doc_id" value="<?php echo $docs_exchange->getDoc_id(); ?>" >
        </div>	
    </div>
    <?php # /doc_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="json" class="form-control" id="json" placeholder="json - textarea" ><?php echo $docs_exchange->getJson(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="pdf_base64" class="form-control" id="pdf_base64" placeholder="pdf_base64 - textarea" ><?php echo $docs_exchange->getPdf_base64(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_send" class="form-control" id="date_send" placeholder="date_send" value="<?php echo $docs_exchange->getDate_send(); ?>" >
        </div>	
    </div>
    <?php # /date_send ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $docs_exchange->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
