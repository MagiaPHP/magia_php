<form class="form-horizontal" action="index.php" method="post" >
        ...
        <div class="col-sm-7">
            <select  name="controller" id="controller" class="form-control selectpicker" data-live-search="true" data-width="100%"   >                                  
                ...
                foreach (controllers_list() as $key => $value) {
                    ...
                    $selected = (isset($controller) && $value['controller'] == $controller ) ? " selected " : "";
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">                    
            ...
            <label class="checkbox-inline">
                <input type="checkbox" name="read" id="read" value="1" checked="">
                <span class="label label-info"><?php _t("Read"); ?></span>
            </label>
            <br>

            <label class="checkbox-inline">
                <input type="checkbox" name="update" id="update" value="1" checked="">
