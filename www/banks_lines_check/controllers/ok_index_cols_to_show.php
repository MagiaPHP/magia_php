...
if (!$error) {
    ...
    _options_push("banks_lines_check_index_cols_to_show", json_encode($data), "banks_lines_check");
    ...
    switch ($redi['redi']) {
        ...
        case 3:
            header("Location: index.php?c=banks_lines_check&a=details&id=" . $redi['id']);
            break;
