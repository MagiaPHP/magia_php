...
if (!$error) {
    ...
    _options_push("config_banks_lines_check_show_col_from_table", $data, 'banks_lines_check');
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=banks_lines_check&a=ok_show_col_from_table&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
