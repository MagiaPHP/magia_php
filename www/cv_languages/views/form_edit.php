...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="language" class="form-control" id="language" placeholder="language"  value="<?php echo $cv_languages->getLanguage(); ?>" >
        </div>	
    </div>
    <?php # /language ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="level" class="form-control" id="level" placeholder="level"  value="<?php echo $cv_languages->getLevel(); ?>" >
        </div>	
    </div>
    <?php # /level ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   value="<?php echo $cv_languages->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
