...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="subjet" class="form-control" id="subjet" placeholder="subjet"  value="<?php echo $emails->getSubjet(); ?>" >
        </div>	
    </div>
    <?php # /subjet ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="message" class="form-control" id="message" placeholder="message - textarea" ><?php echo $emails->getMessage(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_registre" class="form-control" id="date_registre" placeholder="date_registre"  required=""  value="<?php echo $emails->getDate_registre(); ?>" >
        </div>	
    </div>
    <?php # /date_registre ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_read" class="form-control" id="date_read" placeholder="date_read"  value="<?php echo $emails->getDate_read(); ?>" >
        </div>	
    </div>
    <?php # /date_read ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $emails->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
