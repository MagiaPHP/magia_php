...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="name"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # code ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="code"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # rate ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="rate"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # rate_silent ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="rate_silent"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # rate_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="rate_id"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # accuracy ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="accuracy"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # rounding ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="rounding"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # active ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="active"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # company_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="company_id"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # date ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="date"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # base ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="base"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # position ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="position"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # order_by ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="order_by"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # status ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="status"><?php _t("Currencies"); ?></label>
        <div class="col-sm-8">
