...
if (! $error ) {
    ...
    currencies_edit(
        $id ,  $name ,  $code ,  $rate ,  $rate_silent ,  $rate_id ,  $accuracy ,  $rounding ,  $active ,  $company_id ,  $date ,  $base ,  $position ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=currencies&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
