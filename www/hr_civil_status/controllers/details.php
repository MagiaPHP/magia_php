...
# 
if (! hr_civil_status_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_civil_status = new Hr_civil_status();
    $hr_civil_status->setHr_civil_status($id);

    include view("hr_civil_status", "details");
