...
if (!$error) {
    $lastInsertId = hr_civil_status_add(
        $code ,  $description ,  $icon ,  $color ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_civil_status&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
