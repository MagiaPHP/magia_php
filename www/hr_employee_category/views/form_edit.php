...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_start" class="form-control" id="date_start" placeholder="date_start"  required=""  value="<?php echo $hr_employee_category->getDate_start(); ?>" >
        </div>	
    </div>
    <?php # /date_start ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_end" class="form-control" id="date_end" placeholder="date_end"  value="<?php echo $hr_employee_category->getDate_end(); ?>" >
        </div>	
    </div>
    <?php # /date_end ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_employee_category->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
