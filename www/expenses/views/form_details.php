...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="office_id_counter_year_month"><?php _t("Office id counter year month"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="office_id_counter_year_trimestre"><?php _t("Office id counter year trimestre"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="office_id_counter"><?php _t("Office id counter"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # my_ref ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="my_ref"><?php _t("My ref"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # father_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="father_id"><?php _t("Father id"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # credit_note_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="credit_note_id"><?php _t("Credit note id"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # provider_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="provider_id"><?php _t("Provider id"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # seller_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="seller_id"><?php _t("Seller id"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # clon_from_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="clon_from_id"><?php _t("Clon from id"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="addresses_billing"><?php _t("Addresses billing"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="addresses_delivery"><?php _t("Addresses delivery"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="comments_private"><?php _t("Comments private"); ?></label>
        <div class="col-sm-8">
