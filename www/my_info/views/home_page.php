            ...
            <div class="form-group">
                ...
                <div class="input-group">                    
                    ...
                    <select name="home_page" class="form-control" disabled="">
                        <?php
                        $user_options_search_by_user_option = user_options_search_by_user_option($u_id, 'home_page');

                        if (isset($user_options_search_by_user_option)) {
                            $user_options_controller = $user_options_search_by_user_option['data'];
                        } else {
                            $user_options_controller = null;
                        }
...
//                            if (modules_field_module('status', $controller['controller']) && modules_field_module('status', modules_field_module('father', $controller['controller']))) {
                            if (modules_field_module('status', $controller['controller'])) {
                                ...
                                $selected = ( $user_options_controller == $controller['controller'] ) ? " selected " : "";
