...
# F O R M A T O
#
if (! hr_employee_clothes_is_id($id)) {
...
# 
if (! hr_employee_clothes_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_clothes = new Hr_employee_clothes();
    $hr_employee_clothes->setHr_employee_clothes($id);

    include view("hr_employee_clothes", "details");
