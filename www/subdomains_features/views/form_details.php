<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="feature" class="form-control" id="feature" placeholder="feature" value="<?php echo $subdomains_features['feature']; ?>"  disabled="" >
        </div>	
    </div>
    <?php # /feature ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $subdomains_features['order_by']; ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
