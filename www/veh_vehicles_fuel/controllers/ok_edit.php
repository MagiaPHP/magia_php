...
if (! $error ) {
    ...
    veh_vehicles_fuel_edit(
        $id ,  $vehicle_id ,  $fuel_code ,  $date ,  $price ,  $paid_by ,  $ref ,  $notes ,  $registred_by ,  $date_registre ,  $kl ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicles_fuel&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
