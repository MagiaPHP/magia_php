...
# 
if (! veh_vehicles_fuel_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $veh_vehicles_fuel = new Veh_vehicles_fuel();
    $veh_vehicles_fuel->setVeh_vehicles_fuel($id);

    include view("veh_vehicles_fuel", "details");
