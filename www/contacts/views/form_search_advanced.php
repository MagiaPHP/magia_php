...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="birthdate" class="form-control" id="birthdate" placeholder="birthdate"  value="" >
        </div>	
    </div>
    <?php # /birthdate ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="billing_method" class="form-control" id="billing_method" placeholder="billing_method"  value="" >
        </div>	
    </div>
    <?php # /billing_method ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="discounts" class="form-control" id="discounts" placeholder="discounts"   value="" >
        </div>	
    </div>
    <?php # /discounts ?>
