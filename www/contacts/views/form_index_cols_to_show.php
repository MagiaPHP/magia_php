...
<form method="post" action="index.php">
    ...
    foreach ($array_btn as $key => $button) {
        array_push($contacts_db_col_list_from_table, $button);
    }
    ...
    foreach ($contacts_db_col_list_from_table as $key => $cdbcts) {
     ...
     // $contacts_index_cols_to_show_array = json_decode(_options_option("contacts_index_cols_to_show"), true);
            
        
        $config_contacts_show_col_json = _options_option("config_contacts_show_col_from_table");

        
        $checked_array = is_json($config_contacts_show_col_json) ? json_decode($config_contacts_show_col_json, true) : [];
