...
if (! $error ) {
    ...
    contacts_edit(
        $id ,  $owner_id ,  $office_id ,  $type ,  $title ,  $name ,  $lastname ,  $description ,  $birthdate ,  $tva ,  $billing_method ,  $discounts ,  $code ,  $language ,  $registre_date ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=contacts&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
