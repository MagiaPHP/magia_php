...
# 
if (! expenses_references_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $expenses_references = new Expenses_references();
    $expenses_references->setExpenses_references($id);

    include view("expenses_references", "details");
