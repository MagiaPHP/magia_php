...
# 
if (! emails_folders_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $emails_folders = new Emails_folders();
    $emails_folders->setEmails_folders($id);

    include view("emails_folders", "details");
