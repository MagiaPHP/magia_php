...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="folder" class="form-control" id="folder" placeholder="folder"  required=""  value="" >
        </div>	
    </div>
    <?php # /folder ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="icon" class="form-control" id="icon" placeholder="icon"  required=""  value="" >
        </div>	
    </div>
    <?php # /icon ?>
