...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <?php # min_age ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="min_age"><?php _t("Min age"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # max_weight ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="max_weight"><?php _t("Max weight"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # max_passengers ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="max_passengers"><?php _t("Max passengers"); ?></label>
        <div class="col-sm-8">
