...
if (!$error) {
    $lastInsertId = veh_driver_licenses_add(
        $category ,  $description ,  $min_age ,  $max_weight ,  $max_passengers ,  $notes ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_driver_licenses&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
