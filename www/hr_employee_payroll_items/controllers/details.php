...
# F O R M A T O
#
if (! hr_employee_payroll_items_is_id($id)) {
...
# 
if (! hr_employee_payroll_items_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_payroll_items = new Hr_employee_payroll_items();
    $hr_employee_payroll_items->setHr_employee_payroll_items($id);

    include view("hr_employee_payroll_items", "details");
