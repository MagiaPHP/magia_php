...
if (!$error) {
    ...
    _options_push("config_projects_inout_pagination_items_limit", $data, "projects_inout");
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=projects_inout&a=ok_pagination_items_limit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
