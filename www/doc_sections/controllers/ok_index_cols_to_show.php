...
if (!$error) {
    ...
    _options_push("doc_sections_index_cols_to_show", json_encode($data), "doc_sections");
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=doc_sections&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
