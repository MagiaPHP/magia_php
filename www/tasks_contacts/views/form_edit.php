...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_registred" class="form-control" id="date_registred" placeholder="date_registred"  required=""  value="<?php echo $tasks_contacts->getDate_registred(); ?>" >
        </div>	
    </div>
    <?php # /date_registred ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $tasks_contacts->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
