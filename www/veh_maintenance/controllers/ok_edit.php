...
if (! $error ) {
    ...
    veh_maintenance_edit(
        $id ,  $vehicle_id ,  $workshop_id ,  $date ,  $type ,  $next_visit ,  $total ,  $kl ,  $notes ,  $date_registre ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_maintenance&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
