...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="name" class="form-control" id="name" placeholder="name"  required=""  value="<?php echo $hr_employee_family_dependents->getName(); ?>" >
        </div>	
    </div>
    <?php # /name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="lastname" class="form-control" id="lastname" placeholder="lastname"  required=""  value="<?php echo $hr_employee_family_dependents->getLastname(); ?>" >
        </div>	
    </div>
    <?php # /lastname ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="birthday" class="form-control" id="birthday" placeholder="birthday"  value="<?php echo $hr_employee_family_dependents->getBirthday(); ?>" >
        </div>	
    </div>
    <?php # /birthday ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="relation" class="form-control" id="relation" placeholder="relation"  required=""  value="<?php echo $hr_employee_family_dependents->getRelation(); ?>" >
        </div>	
    </div>
    <?php # /relation ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="notes" class="form-control" id="notes" placeholder="notes - textarea" ><?php echo $hr_employee_family_dependents->getNotes(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_employee_family_dependents->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
