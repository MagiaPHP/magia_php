...
<form method="post" action="index.php">
    ...
    foreach ($hr_employee_family_dependents_db_col_list_from_table as $key => $cdbcts) {
     ...
     // $hr_employee_family_dependents_index_cols_to_show_array = json_decode(_options_option("hr_employee_family_dependents_index_cols_to_show"), true);
        ...
        $config_hr_employee_family_dependents_show_col_json = _options_option("config_hr_employee_family_dependents_show_col_from_table");

        
        $checked_array = is_json($config_hr_employee_family_dependents_show_col_json) ? json_decode($config_hr_employee_family_dependents_show_col_json, true) : [];
