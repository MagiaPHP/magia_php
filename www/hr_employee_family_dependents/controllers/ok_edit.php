...
if (! $error ) {
    ...
    hr_employee_family_dependents_edit(
        $id ,  $employee_id ,  $name ,  $lastname ,  $birthday ,  $relation ,  $in_charge ,  $handicap ,  $notes ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_employee_family_dependents&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
