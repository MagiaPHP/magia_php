...
# F O R M A T O
#
if (! hr_employee_family_dependents_is_id($id)) {
...
# 
if (! hr_employee_family_dependents_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_family_dependents = new Hr_employee_family_dependents();
    $hr_employee_family_dependents->setHr_employee_family_dependents($id);

    include view("hr_employee_family_dependents", "details");
