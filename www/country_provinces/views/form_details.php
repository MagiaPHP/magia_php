...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="country"><?php _t("Country provinces"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # code ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="code"><?php _t("Country provinces"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # province ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="province"><?php _t("Country provinces"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # order_by ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="order_by"><?php _t("Country provinces"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # status ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="status"><?php _t("Country provinces"); ?></label>
        <div class="col-sm-8">
