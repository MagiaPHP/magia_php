...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <!-- mg_start father_code -->
    <div class="form-group">
        <label class="control-label col-sm-3" for="father_code"><?php _t(ucfirst("father_code")); ?> </label>
        <div class="col-sm-8">               <select name="father_code" class="form-control selectpicker" id="father_code" data-live-search="true" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">            <input type="text" name="category" class="form-control" id="category" placeholder="category"  value="" >
</div>
    </div>
    <!-- mg_end category -->
