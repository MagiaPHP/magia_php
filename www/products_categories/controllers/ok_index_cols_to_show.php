...
if (!$error) {
    ...
    _options_push("products_categories_index_cols_to_show", json_encode($data), "products_categories");
    ...
    switch ($redi['redi']) {
        ...
        case 3:
            header("Location: index.php?c=products_categories&a=details&id=" . $redi['id']);
            break;        
