  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        <span class="sr-only">Toggle navigation employees</span>
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
      </button>
        <a class="navbar-brand" href="index.php?c=employees">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <?php // include view("employees", "form_search"   , $arg = ["redi" => 1]) ?>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="employees_addLabel">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php                                       
                                        include view("employees", "form_show_col_from_table");
                                        ?>
                ...
                <?php if (
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="index.php?c=employees&a=export_json"><?php _t("Json"); ?></a></li>
                            <li><a href="index.php?c=employees&a=export_pdf"><?php _t("Pdf"); ?></a></li>
                            <li><a href="index.php?c=employees&a=export_csv"><?php _t("CSV"); ?></a></li>
                            <li><a href="index.php?c=employees&a=export_xml"><?php _t("XML"); ?></a></li>
            ...
            $menu_items = _menus_list_by_location_without_father("employees_nav");
            ?>
                ...
                <?php if (!empty($menu_items)): ?>
                    <?php foreach ($menu_items as $item): ?>
                        <?php if (_menus_can_show($item["controller"])): ?>
                            <li>
                                <?= _menus_dropdown_create_html("employees_nav", $item); ?>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php else: ?>
            ...
            /**
            <ul class="nav navbar-nav">
                <li><a href="index.php?c=employees&a=search_advanced"><?php _t("Search avanced"); ?></a></li>
...
<div class="collapse navbar-collapse" id="employees_add">
            ...
            ?>
                ...
                <?php if (permissions_has_permission($u_rol, "employees", "create")) { ?>     
                    ...
                    <button type="button" class="btn btn-primary navbar-btn navbar-right" data-toggle="modal" data-target="#employeesModal">
                        <span class="glyphicon glyphicon-plus-sign"></span>
                        <?php _t("New employees"); ?>
                    </button>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                     <h4 class="modal-title" id="employees_addLabel">
                                        <?php _t("Add new employees"); ?>                
                                    </h4>
                                </div>
                                
                                <div class="modal-body">
                                    <?php include view("employees", "form_add"); ?>
                                </div>
