...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
               <select name="mg_form_id" class="form-control selectpicker" id="mg_form_id" data-live-search="true"  disabled="" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
               <select name="mg_type" class="form-control selectpicker" id="mg_type" data-live-search="true"  disabled="" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="mg_external_table" class="form-control" id="mg_external_table" placeholder="mg_external_table - textarea"  disabled="" ><?php echo $magia_forms_lines->getMg_external_table(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="mg_external_col" class="form-control" id="mg_external_col" placeholder="mg_external_col - textarea"  disabled="" ><?php echo $magia_forms_lines->getMg_external_col(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_label" class="form-control" id="mg_label" placeholder="mg_label"  required=""  value="<?php echo $magia_forms_lines->getMg_label(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /mg_label ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="mg_help_text" class="form-control" id="mg_help_text" placeholder="mg_help_text - textarea"  disabled="" ><?php echo $magia_forms_lines->getMg_help_text(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_name" class="form-control" id="mg_name" placeholder="mg_name"  required=""  value="<?php echo $magia_forms_lines->getMg_name(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /mg_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_id" class="form-control" id="mg_id" placeholder="mg_id"  value="<?php echo $magia_forms_lines->getMg_id(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /mg_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_placeholder" class="form-control" id="mg_placeholder" placeholder="mg_placeholder"  value="<?php echo $magia_forms_lines->getMg_placeholder(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /mg_placeholder ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_value" class="form-control" id="mg_value" placeholder="mg_value"  value="<?php echo $magia_forms_lines->getMg_value(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /mg_value ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_class" class="form-control" id="mg_class" placeholder="mg_class"  value="<?php echo $magia_forms_lines->getMg_class(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /mg_class ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="mg_required" class="form-control" id="mg_required"  disabled="" >                
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="mg_disabled" class="form-control" id="mg_disabled"  disabled="" >                
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $magia_forms_lines->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
