...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="mg_external_table" class="form-control" id="mg_external_table" placeholder="mg_external_table - textarea" ></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="mg_external_col" class="form-control" id="mg_external_col" placeholder="mg_external_col - textarea" ></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_label" class="form-control" id="mg_label" placeholder="mg_label"  required=""  value="" >
        </div>	
    </div>
    <?php # /mg_label ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="mg_help_text" class="form-control" id="mg_help_text" placeholder="mg_help_text - textarea" ></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_name" class="form-control" id="mg_name" placeholder="mg_name"  required=""  value="" >
        </div>	
    </div>
    <?php # /mg_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_id" class="form-control" id="mg_id" placeholder="mg_id"  value="" >
        </div>	
    </div>
    <?php # /mg_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_placeholder" class="form-control" id="mg_placeholder" placeholder="mg_placeholder"  value="" >
        </div>	
    </div>
    <?php # /mg_placeholder ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_value" class="form-control" id="mg_value" placeholder="mg_value"  value="" >
        </div>	
    </div>
    <?php # /mg_value ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="mg_class" class="form-control" id="mg_class" placeholder="mg_class"  value="" >
        </div>	
    </div>
    <?php # /mg_class ?>
