<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="product_code" class="form-control" id="product_code" placeholder="product_code" value="<?php echo $products_origin->getProduct_code(); ?>" >
        </div>	
    </div>
    <?php # /product_code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="country" class="form-control" id="country" placeholder="country" value="<?php echo $products_origin->getCountry(); ?>" >
        </div>	
    </div>
    <?php # /country ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $products_origin->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
