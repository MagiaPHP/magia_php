...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="clothes_code" class="form-control" id="clothes_code" placeholder="clothes_code"  required=""  value="" >
        </div>	
    </div>
    <?php # /clothes_code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="size" class="form-control" id="size" placeholder="size"  required=""  value="" >
        </div>	
    </div>
    <?php # /size ?>
