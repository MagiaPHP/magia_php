...
# 
if (! hr_employee_sizes_clothes_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_sizes_clothes = new Hr_employee_sizes_clothes();
    $hr_employee_sizes_clothes->setHr_employee_sizes_clothes($id);

    include view("hr_employee_sizes_clothes", "details");
