...
if (!$error) {
    $lastInsertId = hr_employee_sizes_clothes_add(
        $employee_id ,  $clothes_code ,  $size ,  $notes ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_employee_sizes_clothes&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
