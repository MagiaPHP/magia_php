...
if (!$error) {
    $lastInsertId = veh_maintenance_lines_add(
        $maintenance_id ,  $description ,  $price ,  $quantity ,  $total ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_maintenance_lines&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
