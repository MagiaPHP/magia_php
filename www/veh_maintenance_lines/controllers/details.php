...
# F O R M A T O
#
if (! veh_maintenance_lines_is_id($id)) {
...
# 
if (! veh_maintenance_lines_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $veh_maintenance_lines = new Veh_maintenance_lines();
    $veh_maintenance_lines->setVeh_maintenance_lines($id);

    include view("veh_maintenance_lines", "details");
