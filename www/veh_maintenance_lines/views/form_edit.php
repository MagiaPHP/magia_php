...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="description" class="form-control" id="description" placeholder="description"  required=""  value="<?php echo $veh_maintenance_lines->getDescription(); ?>" >
        </div>	
    </div>
    <?php # /description ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="price" class="form-control" id="price" placeholder="price"   required=""  value="<?php echo $veh_maintenance_lines->getPrice(); ?>" >
        </div>	
    </div>
    <?php # /price ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="quantity" class="form-control" id="quantity" placeholder="quantity"   required=""  value="<?php echo $veh_maintenance_lines->getQuantity(); ?>" >
        </div>	
    </div>
    <?php # /quantity ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="total" class="form-control" id="total" placeholder="total"   value="<?php echo $veh_maintenance_lines->getTotal(); ?>" >
        </div>	
    </div>
    <?php # /total ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $veh_maintenance_lines->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
