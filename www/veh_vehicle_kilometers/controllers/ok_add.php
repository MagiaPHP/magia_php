...
if (!$error) {
    $lastInsertId = veh_vehicle_kilometers_add(
        $vehicle_id ,  $event_date ,  $kl ,  $event_type ,  $event_id ,  $created_at ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicle_kilometers&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
