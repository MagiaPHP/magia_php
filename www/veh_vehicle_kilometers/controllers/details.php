...
# F O R M A T O
#
if (! veh_vehicle_kilometers_is_id($id)) {
...
# 
if (! veh_vehicle_kilometers_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $veh_vehicle_kilometers = new Veh_vehicle_kilometers();
    $veh_vehicle_kilometers->setVeh_vehicle_kilometers($id);

    include view("veh_vehicle_kilometers", "details");
