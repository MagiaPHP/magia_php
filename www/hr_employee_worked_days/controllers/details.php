...
# 
if (! hr_employee_worked_days_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_worked_days = new Hr_employee_worked_days();
    $hr_employee_worked_days->setHr_employee_worked_days($id);

    include view("hr_employee_worked_days", "details");
