...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <?php # start_am ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="start_am"><?php _t("Start am"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # end_am ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="end_am"><?php _t("End am"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # end_pm ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="end_pm"><?php _t("End pm"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # total_hours ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="total_hours"><?php _t("Total hours"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # project_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="project_id"><?php _t("Project id"); ?></label>
        <div class="col-sm-8">
