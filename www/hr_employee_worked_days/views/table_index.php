...
<table class="table table-striped table-condensed table-bordered">
    ...
    <thead>
        <tr class="info">
            ...
            order_by_render_table_headers_with_icons($user_cols_array, "hr_employee_worked_days", $order_data["col_name"], $order_data["order_way"]);
            ?>
        </tr>
    </thead>
                ...
                if ($col["show"]) {
                    ...
                    switch ($field) {
                     ...
                     case 'total_hours':
                        ...
                        break;
                     case 'project_id':
                        echo '<td><a href="index.php?c=projects&a=details&id=' . $hr_employee_worked_days_item['project_id'] . '">' . projects_field_id("name", $hr_employee_worked_days_item['project_id'] ?? null) . '</a></td>';
                        break;
                     case 'notes':
                        echo '<td>' . ($hr_employee_worked_days_item[$field]) . '</td>';
                        break;
