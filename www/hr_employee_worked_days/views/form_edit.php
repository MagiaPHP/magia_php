...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date" class="form-control" id="date" placeholder="date"  required=""  value="<?php echo $hr_employee_worked_days->getDate(); ?>" >
        </div>	
    </div>
    <?php # /date ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="start_am" class="form-control" id="start_am" placeholder="start_am"  value="<?php echo $hr_employee_worked_days->getStart_am(); ?>" >
        </div>	
    </div>
    <?php # /start_am ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="end_am" class="form-control" id="end_am" placeholder="end_am"  value="<?php echo $hr_employee_worked_days->getEnd_am(); ?>" >
        </div>	
    </div>
    <?php # /end_am ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="lunch" class="form-control" id="lunch" placeholder="lunch"  value="<?php echo $hr_employee_worked_days->getLunch(); ?>" >
        </div>	
    </div>
    <?php # /lunch ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="start_pm" class="form-control" id="start_pm" placeholder="start_pm"  value="<?php echo $hr_employee_worked_days->getStart_pm(); ?>" >
        </div>	
    </div>
    <?php # /start_pm ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="end_pm" class="form-control" id="end_pm" placeholder="end_pm"  value="<?php echo $hr_employee_worked_days->getEnd_pm(); ?>" >
        </div>	
    </div>
    <?php # /end_pm ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="total_hours" class="form-control" id="total_hours" placeholder="total_hours"  value="<?php echo $hr_employee_worked_days->getTotal_hours(); ?>" >
        </div>	
    </div>
    <?php # /total_hours ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="notes" class="form-control" id="notes" placeholder="notes - textarea" ><?php echo $hr_employee_worked_days->getNotes(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_employee_worked_days->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="year" class="form-control" id="year" placeholder="year"  value="<?php echo $hr_employee_worked_days->getYear(); ?>" >
        </div>	
    </div>
    <?php # /year ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="month" class="form-control" id="month" placeholder="month"  value="<?php echo $hr_employee_worked_days->getMonth(); ?>" >
        </div>	
    </div>
    <?php # /month ?>
