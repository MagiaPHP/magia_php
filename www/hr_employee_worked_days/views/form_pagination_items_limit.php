...
<form class="form-inline" method="post" action="index.php">
    ...
    <input type="hidden" name="option" value="hr_employee_worked_days_pagination_items_limit">                                                         
        
    <input type="hidden" name="redi[redi]" value="5">                                                          
    <input type="hidden" name="redi[c]" value="hr_employee_worked_days">                                                          
    ...
    <div class="form-group">
        ...
        <div class="input-group">                    
            <input 
                ...
                name="data" 
                placeholder="" 
                value="<?php echo user_options("hr_employee_worked_days_pagination_items_limit", $u_id); ?>"> 
