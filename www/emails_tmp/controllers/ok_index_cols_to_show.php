...
if (!$error) {
    ...
    _options_push("emails_tmp_index_cols_to_show", json_encode($data), "emails_tmp");
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=emails_tmp&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
