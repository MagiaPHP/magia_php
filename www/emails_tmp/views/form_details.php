...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="contact_id"><?php _t("Emails tmp"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # controller ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="controller"><?php _t("Emails tmp"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # tmp ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="tmp"><?php _t("Emails tmp"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # body ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="body"><?php _t("Emails tmp"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # order_by ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="order_by"><?php _t("Emails tmp"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # status ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="status"><?php _t("Emails tmp"); ?></label>
        <div class="col-sm-8">
