...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="contact_id" class="form-control" id="contact_id" placeholder="contact_id"   value="<?php echo $emails_tmp->getContact_id(); ?>" >
        </div>	
    </div>
    <?php # /contact_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="tmp" class="form-control" id="tmp" placeholder="tmp"  value="<?php echo $emails_tmp->getTmp(); ?>" >
        </div>	
    </div>
    <?php # /tmp ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="body" class="form-control" id="body" placeholder="body - textarea" ><?php echo $emails_tmp->getBody(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $emails_tmp->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
