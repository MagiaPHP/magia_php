...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <?php # url_action ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="url_action"><?php _t("Url action"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # url_label ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="url_label"><?php _t("Url label"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # read_by ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="read_by"><?php _t("Read by"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # is_logued ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="is_logued"><?php _t("Is logued"); ?></label>
        <div class="col-sm-8">
