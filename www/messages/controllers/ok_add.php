...
if (!$error) {
    $lastInsertId = messages_add(
        $type ,  $message ,  $url_action ,  $url_label ,  $controller ,  $doc_id ,  $contact_id ,  $rol ,  $date_start ,  $date_end ,  $date_registre ,  $read_by ,  $is_logued ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=messages&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
