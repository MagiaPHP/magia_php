...
# F O R M A T O
#
if (! hr_employee_nationality_is_id($id)) {
...
# 
if (! hr_employee_nationality_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_nationality = new Hr_employee_nationality();
    $hr_employee_nationality->setHr_employee_nationality($id);

    include view("hr_employee_nationality", "details");
