...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">            <input type="text" name="nationality" class="form-control" id="nationality" placeholder="nationality"  required=""  value="" >
</div>
    </div>
    <!-- mg_end nationality -->
    ...
    <!-- mg_start principal -->
    <div class="form-group">
        <label class="control-label col-sm-3" for="principal"><?php _t(ucfirst("principal")); ?> </label>
        <div class="col-sm-8">            <select name="principal" class="form-control" id="principal" >                
