...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="employee_id" class="form-control" id="employee_id" placeholder="employee_id"   required=""  value="<?php echo $hr_employee_nationality->getEmployee_id(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /employee_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="nationality" class="form-control" id="nationality" placeholder="nationality"  required=""  value="<?php echo $hr_employee_nationality->getNationality(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /nationality ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_employee_nationality->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
