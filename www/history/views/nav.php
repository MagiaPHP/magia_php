  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        <span class="sr-only">Toggle navigation history</span>
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
      </button>
        <a class="navbar-brand" href="index.php?c=history">
            <?php _menu_icon("top" , 'history'); ?>
            <?php echo ( _options_option("config_menus_debug") ) ? _menus_get_file_name(__FILE__) : _t("History"); ?>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <?php // include view("history", "form_search"   , $arg = ["redi" => 1]) ?>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="history_addLabel">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php                                       
                                        include view("history", "form_show_col_from_table");
                                        ?>
                ...
                <?php if (
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="index.php?c=history&a=export_json"><?php _t("Json"); ?></a></li>
                            <li><a href="index.php?c=history&a=export_pdf"><?php _t("Pdf"); ?></a></li>
                            <li><a href="index.php?c=history&a=export_csv"><?php _t("CSV"); ?></a></li>
                            <li><a href="index.php?c=history&a=export_xml"><?php _t("XML"); ?></a></li>
            ...
            $menu_items = _menus_list_by_location_without_father("history_nav");
            ?>
                ...
                <?php if (!empty($menu_items)): ?>
                    <?php foreach ($menu_items as $item): ?>
                        <?php if (_menus_can_show($item["controller"])): ?>
                            <li>
                                <?= _menus_dropdown_create_html("history_nav", $item); ?>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php else: ?>
            ...
            /**
            <ul class="nav navbar-nav">
                <li><a href="index.php?c=history&a=search_advanced"><?php _t("Search avanced"); ?></a></li>
...
<div class="collapse navbar-collapse" id="history_add">
            ...
            ?>
                ...
                <?php if (permissions_has_permission($u_rol, "history", "create")) { ?>     
                    ...
                    <button type="button" class="btn btn-primary navbar-btn navbar-right" data-toggle="modal" data-target="#historyModal">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                     <h4 class="modal-title" id="history_addLabel">
                                        <?php _t("Add new history"); ?>                
                                    </h4>
                                </div>
                                
                                <div class="modal-body">
                                    <?php include view("history", "form_add"); ?>
                                </div>
