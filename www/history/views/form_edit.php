...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="details" class="form-control" id="details" placeholder="details - textarea" ><?php echo $history->getDetails(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="registre_date" class="form-control" id="registre_date" placeholder="registre_date"  required=""  value="<?php echo $history->getRegistre_date(); ?>" >
        </div>	
    </div>
    <?php # /registre_date ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $history->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
