<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text"   name="code" class="form-control" id="code" placeholder="code" value="<?php echo $transport['code']; ?>" >
        </div>	
    </div>
    <?php # /code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number"  name="price" class="form-control" id="price" placeholder="price" value="<?php echo $transport['price']; ?>" >
        </div>	
    </div>
    <?php # /price ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number"  name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $transport['order_by']; ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
