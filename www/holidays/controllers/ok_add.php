...
if (!$error) {
    $lastInsertId = holidays_add(
        $country ,  $category_code ,  $date ,  $description ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=holidays&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
