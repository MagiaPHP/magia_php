...
# 
if (! banks_templates_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $banks_templates = new Banks_templates();
    $banks_templates->setBanks_templates($id);

    include view("banks_templates", "details");
