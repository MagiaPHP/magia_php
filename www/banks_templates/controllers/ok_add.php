...
if (!$error) {
    $lastInsertId = banks_templates_add(
        $template ,  $label ,  $description ,  $icon ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=banks_templates&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
