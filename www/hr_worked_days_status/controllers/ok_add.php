...
if (!$error) {
    $lastInsertId = hr_worked_days_status_add(
        $code ,  $status_name ,  $color ,  $icon ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_worked_days_status&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
