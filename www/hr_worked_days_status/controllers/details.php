...
# F O R M A T O
#
if (! hr_worked_days_status_is_id($id)) {
...
# 
if (! hr_worked_days_status_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_worked_days_status = new Hr_worked_days_status();
    $hr_worked_days_status->setHr_worked_days_status($id);

    include view("hr_worked_days_status", "details");
