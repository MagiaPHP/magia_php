...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_id" class="form-control" id="order_id" placeholder="order_id"   required=""  value="<?php echo $chat->getOrder_id(); ?>" >
        </div>	
    </div>
    <?php # /order_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="message" class="form-control" id="message" placeholder="message"  required=""  value="<?php echo $chat->getMessage(); ?>" >
        </div>	
    </div>
    <?php # /message ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="user" class="form-control" id="user" placeholder="user"  required=""  value="<?php echo $chat->getUser(); ?>" >
        </div>	
    </div>
    <?php # /user ?>
