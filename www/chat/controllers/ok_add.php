...
if (!$error) {
    $lastInsertId = chat_add(
        $contact_id ,  $order_id ,  $message ,  $user    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=chat&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
