...
<div class="modal fade" id="veh_vehicles_drivers_delete_<?php echo $veh_vehicles_drivers_item['id']?>" tabindex="-1" role="dialog" aria-labelledby="veh_vehicles_drivers_delete_<?php echo $veh_vehicles_drivers_item['id']?>Label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="veh_vehicles_drivers_delete_<?php echo $veh_vehicles_drivers_item['id']?>Label"> <?php _t("Delete"); ?>
    ...
    <div class="modal-footer"> 
                ...
                switch ($c) {
                    case "contacts":
                        $url_redi = "index.php?c=contacts&a=veh_vehicles_drivers&id=id=$id";
                        break;

                    case "veh_vehicles_drivers":
                        $url_redi = "index.php?c=veh_vehicles_drivers&a=ok_delete&id=$veh_vehicles_drivers_item[id]&redi[redi]=1&";
                        break;
