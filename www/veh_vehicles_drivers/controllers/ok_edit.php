...
if (! $error ) {
    ...
    veh_vehicles_drivers_edit(
        $id ,  $vehicle_id ,  $driver_id ,  $date_start ,  $date_end ,  $notes ,  $date_registre ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicles_drivers&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
