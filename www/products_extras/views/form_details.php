<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="extra_name" class="form-control" id="extra_name" placeholder="extra_name" value="<?php echo $products_extras->getExtra_name(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /extra_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="extra_value" class="form-control" id="extra_value" placeholder="extra_value" value="<?php echo $products_extras->getExtra_value(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /extra_value ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="price" class="form-control" id="price" placeholder="price" value="<?php echo $products_extras->getPrice(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /price ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $products_extras->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
