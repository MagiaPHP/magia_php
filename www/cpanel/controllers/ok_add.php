...
if (!$error) {
    $lastInsertId = cpanel_add(
        $contact_id ,  $domain ,  $subdomain ,  $db ,  $user_db ,  $user_db_pass ,  $email ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=cpanel&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
