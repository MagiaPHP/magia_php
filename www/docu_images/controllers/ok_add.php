...
if (!$error) {
    $lastInsertId = docu_images_add(
        $docu_id ,  $bloc_id ,  $image ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=docu_images&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
