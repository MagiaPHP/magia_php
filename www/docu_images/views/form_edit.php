...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="image" class="form-control" id="image" placeholder="image - textarea" ><?php echo $docu_images->getImage(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $docu_images->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
