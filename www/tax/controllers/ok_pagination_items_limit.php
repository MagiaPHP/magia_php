...
if (!$error) {
    ...
    _options_push("config_tax_pagination_items_limit", $data, "tax");
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=tax&a=ok_pagination_items_limit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
