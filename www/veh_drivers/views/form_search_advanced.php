...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="license" class="form-control" id="license" placeholder="license"  required=""  value="" >
        </div>	
    </div>
    <?php # /license ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="type" class="form-control" id="type" placeholder="type"  required=""  value="" >
        </div>	
    </div>
    <?php # /type ?>
