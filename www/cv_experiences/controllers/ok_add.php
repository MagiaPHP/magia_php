...
if (!$error) {
    $lastInsertId = cv_experiences_add(
        $cv_id ,  $role ,  $company ,  $employment_type ,  $start_date ,  $end_date ,  $description ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=cv_experiences&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
