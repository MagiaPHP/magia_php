...
if (!$error) {
    $lastInsertId = addresses_add(
        $contact_id ,  $name ,  $address ,  $number ,  $postcode ,  $barrio ,  $sector ,  $ref ,  $city ,  $province ,  $region ,  $country ,  $code ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=addresses&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
