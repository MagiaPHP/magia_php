...
# F O R M A T O
#
if (! hr_employee_benefits_is_id($id)) {
...
# 
if (! hr_employee_benefits_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    ...
    $hr_employee_benefits->setHr_employee_benefits($id);

    include view("hr_employee_benefits", "details");
