...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="employee_id" class="form-control" id="employee_id" placeholder="employee_id"   required=""  value="<?php echo $hr_employee_benefits->getEmployee_id(); ?>" >
        </div>	
    </div>
    <?php # /employee_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="benefit_code" class="form-control" id="benefit_code" placeholder="benefit_code"  required=""  value="<?php echo $hr_employee_benefits->getBenefit_code(); ?>" >
        </div>	
    </div>
    <?php # /benefit_code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="price" class="form-control" id="price" placeholder="price"   value="<?php echo $hr_employee_benefits->getPrice(); ?>" >
        </div>	
    </div>
    <?php # /price ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="company_part" class="form-control" id="company_part" placeholder="company_part"   value="<?php echo $hr_employee_benefits->getCompany_part(); ?>" >
        </div>	
    </div>
    <?php # /company_part ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="employee_part" class="form-control" id="employee_part" placeholder="employee_part"   value="<?php echo $hr_employee_benefits->getEmployee_part(); ?>" >
        </div>	
    </div>
    <?php # /employee_part ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_employee_benefits->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
