...
if (!$error) {
    ...
    _options_push("products_presentation_index_cols_to_show", json_encode($data), "products_presentation");
    ...
    switch ($redi['redi']) {
        ...
        case 3:
            header("Location: index.php?c=products_presentation&a=details&id=" . $redi['id']);
            break;        
