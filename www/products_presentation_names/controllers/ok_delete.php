...
# FORMAT
################################################################################
if (! products_presentation_names_is_id($id)) {
...
if ( !$error) {
        ...
        products_presentation_names_delete(
                $id
        );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=products_presentation_names&a=ok_delete&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
