<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="presentation" class="form-control" id="presentation" placeholder="presentation" value="<?php echo $products_presentation_names->getPresentation(); ?>" >
        </div>	
    </div>
    <?php # /presentation ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $products_presentation_names->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
