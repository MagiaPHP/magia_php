<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_label" class="form-control" id="m_label" placeholder="m_label" value="<?php echo $forms_lines->getM_label(); ?>" >
        </div>	
    </div>
    <?php # /m_label ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_type" class="form-control" id="m_type" placeholder="m_type" value="<?php echo $forms_lines->getM_type(); ?>" >
        </div>	
    </div>
    <?php # /m_type ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_class" class="form-control" id="m_class" placeholder="m_class" value="<?php echo $forms_lines->getM_class(); ?>" >
        </div>	
    </div>
    <?php # /m_class ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_name" class="form-control" id="m_name" placeholder="m_name" value="<?php echo $forms_lines->getM_name(); ?>" >
        </div>	
    </div>
    <?php # /m_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_id" class="form-control" id="m_id" placeholder="m_id" value="<?php echo $forms_lines->getM_id(); ?>" >
        </div>	
    </div>
    <?php # /m_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_placeholder" class="form-control" id="m_placeholder" placeholder="m_placeholder" value="<?php echo $forms_lines->getM_placeholder(); ?>" >
        </div>	
    </div>
    <?php # /m_placeholder ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_value" class="form-control" id="m_value" placeholder="m_value" value="<?php echo $forms_lines->getM_value(); ?>" >
        </div>	
    </div>
    <?php # /m_value ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_table_external" class="form-control" id="m_table_external" placeholder="m_table_external" value="<?php echo $forms_lines->getM_table_external(); ?>" >
        </div>	
    </div>
    <?php # /m_table_external ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_col_external" class="form-control" id="m_col_external" placeholder="m_col_external" value="<?php echo $forms_lines->getM_col_external(); ?>" >
        </div>	
    </div>
    <?php # /m_col_external ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_label_external" class="form-control" id="m_label_external" placeholder="m_label_external" value="<?php echo $forms_lines->getM_label_external(); ?>" >
        </div>	
    </div>
    <?php # /m_label_external ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="m_options_values" class="form-control" id="m_options_values" placeholder="m_options_values - textarea" ><?php echo $forms_lines->getM_options_values(); ?></textarea>
        </div>	
    </div>
    <?php # /m_options_values ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $forms_lines->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
