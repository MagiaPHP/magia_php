...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">            <input type="text" name="column" class="form-control" id="column" placeholder="column"  required=""  value="" >
</div>
    </div>
    <!-- mg_end column -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">            <input type="number" step="any" name="value" class="form-control" id="value" placeholder="value"   value="0.000000" >
</div>
    </div>
    <!-- mg_end value -->
