...
# F O R M A T O
#
if (! hr_payroll_by_month_is_id($id)) {
...
# 
if (! hr_payroll_by_month_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_payroll_by_month = new Hr_payroll_by_month();
    $hr_payroll_by_month->setHr_payroll_by_month($id);

    include view("hr_payroll_by_month", "details");
