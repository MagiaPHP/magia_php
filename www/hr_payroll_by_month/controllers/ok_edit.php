...
if (! $error ) {
    ...
    hr_payroll_by_month_edit(
        $id ,  $employee_id ,  $year ,  $month ,  $column ,  $value ,  $formule ,  $notes ,  $code ,  $date_registre ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_payroll_by_month&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
