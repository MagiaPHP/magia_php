...
if (!$error) {
    $lastInsertId = nationalities_add(
        $num_code ,  $alpha_2_code ,  $alpha_3_code ,  $en_short_name ,  $nationality ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=nationalities&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
