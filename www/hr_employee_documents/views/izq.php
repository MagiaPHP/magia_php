...
<div class="list-group">
    <a href="#" class="list-group-item active">
        <?php _menu_icon("top", "hr_employee_documents"); ?>
        <?php echo _t("By hr employee documents"); ?>
    </a>
    <?php
...
<div class="list-group">
    ...
    <?php
    foreach (hr_employee_documents_unique_from_col("follow") as $follow) {
        if ($follow['follow'] != "") {
            echo '<a href="index.php?c=hr_employee_documents&a=search&w=by_follow&follow=' . $follow['follow'] . '" class="list-group-item">' . $follow['follow'] . '</a>';
        }
    }
    ?>
</div>
