...
# F O R M A T O
#
if (! hr_employee_documents_is_id($id)) {
...
# 
if (! hr_employee_documents_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_documents = new Hr_employee_documents();
    $hr_employee_documents->setHr_employee_documents($id);

    include view("hr_employee_documents", "details");
