...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_entry" class="form-control" id="date_entry" placeholder="date_entry"  value="<?php echo $hr_payroll->getDate_entry(); ?>" >
        </div>	
    </div>
    <?php # /date_entry ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="address" class="form-control" id="address" placeholder="address - textarea" ><?php echo $hr_payroll->getAddress(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="fonction" class="form-control" id="fonction" placeholder="fonction"  required=""  value="<?php echo $hr_payroll->getFonction(); ?>" >
        </div>	
    </div>
    <?php # /fonction ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="salary_base" class="form-control" id="salary_base" placeholder="salary_base"   value="<?php echo $hr_payroll->getSalary_base(); ?>" >
        </div>	
    </div>
    <?php # /salary_base ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="civil_status" class="form-control" id="civil_status" placeholder="civil_status"  value="<?php echo $hr_payroll->getCivil_status(); ?>" >
        </div>	
    </div>
    <?php # /civil_status ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="tax_system" class="form-control" id="tax_system" placeholder="tax_system - textarea" ><?php echo $hr_payroll->getTax_system(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="value_round" class="form-control" id="value_round" placeholder="value_round"   value="<?php echo $hr_payroll->getValue_round(); ?>" >
        </div>	
    </div>
    <?php # /value_round ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="to_pay" class="form-control" id="to_pay" placeholder="to_pay"   required=""  value="<?php echo $hr_payroll->getTo_pay(); ?>" >
        </div>	
    </div>
    <?php # /to_pay ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="extras" class="form-control" id="extras" placeholder="extras - textarea" ><?php echo $hr_payroll->getExtras(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="code" class="form-control" id="code" placeholder="code"  required=""  value="<?php echo $hr_payroll->getCode(); ?>" >
        </div>	
    </div>
    <?php # /code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_registre" class="form-control" id="date_registre" placeholder="date_registre"  required=""  value="<?php echo $hr_payroll->getDate_registre(); ?>" >
        </div>	
    </div>
    <?php # /date_registre ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_payroll->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
