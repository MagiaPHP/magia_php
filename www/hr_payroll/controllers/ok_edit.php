...
if (! $error ) {
    ...
    hr_payroll_edit(
        $id ,  $employee_id ,  $date_entry ,  $address ,  $fonction ,  $salary_base ,  $civil_status ,  $tax_system ,  $date_start ,  $date_end ,  $value_round ,  $to_pay ,  $account_number ,  $notes ,  $extras ,  $code ,  $date_registre ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_payroll&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
