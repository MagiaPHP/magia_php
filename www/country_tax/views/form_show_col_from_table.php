...
//            "button_save",
        ...
        $checked_array = is_json($config_country_tax_show_col_json) ? json_decode($config_country_tax_show_col_json, true)['cols'] : [];


        //$checked_array = json_decode(_options_option("config_country_tax_show_col_from_table"), true)['cols'];
