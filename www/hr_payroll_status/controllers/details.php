...
# 
if (! hr_payroll_status_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_payroll_status = new Hr_payroll_status();
    $hr_payroll_status->setHr_payroll_status($id);

    include view("hr_payroll_status", "details");
