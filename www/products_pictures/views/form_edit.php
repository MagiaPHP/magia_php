<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="picture_id" class="form-control" id="picture_id" placeholder="picture_id" value="<?php echo $products_pictures->getPicture_id(); ?>" >
        </div>	
    </div>
    <?php # /picture_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $products_pictures->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
