...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="insurer_code" class="form-control" id="insurer_code" placeholder="insurer_code"  required=""  value="<?php echo $veh_insurers->getInsurer_code(); ?>" >
        </div>	
    </div>
    <?php # /insurer_code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $veh_insurers->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
