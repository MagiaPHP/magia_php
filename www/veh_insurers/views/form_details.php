...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="insurer_id"><?php _t("Insurer id"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # insurer_code ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="insurer_code"><?php _t("Insurer code"); ?></label>
        <div class="col-sm-8">
