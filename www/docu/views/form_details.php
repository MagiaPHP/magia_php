...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="controllers" class="form-control" id="controllers" placeholder="controllers"  required=""  value="<?php echo $docu->getControllers(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /controllers ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="action" class="form-control" id="action" placeholder="action"  required=""  value="<?php echo $docu->getAction(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /action ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="language" class="form-control" id="language" placeholder="language"  required=""  value="<?php echo $docu->getLanguage(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /language ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="title" class="form-control" id="title" placeholder="title"  value="<?php echo $docu->getTitle(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /title ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="post" class="form-control" id="post" placeholder="post - textarea"  disabled="" ><?php echo $docu->getPost(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $docu->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
