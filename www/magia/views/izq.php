...
<div class="list-group">
    ...
    <?php
    foreach (magia_unique_from_col("form_id") as $form_id) {
        if ($form_id['form_id'] != "") {
            echo '<a href="index.php?c=magia&a=search&w=by_form_id&form_id=' . $form_id['form_id'] . '" class="list-group-item">' . $form_id['form_id'] . '</a>';
        }
    }
    ?>
</div>
