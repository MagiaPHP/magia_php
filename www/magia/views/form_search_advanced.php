...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="form_id" class="form-control" id="form_id" placeholder="form_id"   value="" >
        </div>	
    </div>
    <?php # /form_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_db" class="form-control" id="m_db" placeholder="m_db"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_db ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_table" class="form-control" id="m_table" placeholder="m_table"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_table ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_field_name" class="form-control" id="m_field_name" placeholder="m_field_name"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_field_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_action" class="form-control" id="m_action" placeholder="m_action"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_action ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_label" class="form-control" id="m_label" placeholder="m_label"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_label ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_type" class="form-control" id="m_type" placeholder="m_type"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_type ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_class" class="form-control" id="m_class" placeholder="m_class"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_class ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_table_external" class="form-control" id="m_table_external" placeholder="m_table_external"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_table_external ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_col_external" class="form-control" id="m_col_external" placeholder="m_col_external"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_col_external ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_name" class="form-control" id="m_name" placeholder="m_name"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_id" class="form-control" id="m_id" placeholder="m_id"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_placeholder" class="form-control" id="m_placeholder" placeholder="m_placeholder"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_placeholder ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_value" class="form-control" id="m_value" placeholder="m_value"  required=""  value="" >
        </div>	
    </div>
    <?php # /m_value ?>
