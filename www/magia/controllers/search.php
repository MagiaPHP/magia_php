...
switch ($w) {
    ...
    case "by_form_id":
        ...
        $pagination = new Pagination($page, magia_search_by("form_id", $form_id));
        // puede hacer falta
        $url = "index.php?c=magia&a=search&w=by_form_id&form_id=" . $form_id;
        $pagination->setUrl($url);
        $magia = magia_search_by("form_id", $form_id, $pagination->getStart(), $pagination->getLimit());
        #################################################################################
