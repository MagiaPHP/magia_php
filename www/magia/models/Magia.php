...
class Magia {
    ...
    * m_table_external
    */ 
    private $_m_table_external;
    /** 
    * m_col_external
    */ 
    private $_m_col_external;
    /** 
    * m_name
    */ 
    private $_m_name;
    ...
    * m_only_read
    */ 
    private $_m_only_read;
    /** 
    * m_mandatory
    */ 
    private $_m_mandatory;
    /** 
    * m_selected
    */ 
    private $_m_selected;
...
//        return magia_function($col_name, $value);
    ...
    function is_form_id($form_id) {
        return magia_is_form_id($form_id);
    }
