...
# 
if (! hr_employee_civil_status_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_civil_status = new Hr_employee_civil_status();
    $hr_employee_civil_status->setHr_employee_civil_status($id);

    include view("hr_employee_civil_status", "details");
