...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="employee_id" class="form-control" id="employee_id" placeholder="employee_id"   required=""  value="<?php echo $hr_employee_civil_status->getEmployee_id(); ?>" >
        </div>	
    </div>
    <?php # /employee_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="civil_status" class="form-control" id="civil_status" placeholder="civil_status"  required=""  value="<?php echo $hr_employee_civil_status->getCivil_status(); ?>" >
        </div>	
    </div>
    <?php # /civil_status ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_employee_civil_status->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
