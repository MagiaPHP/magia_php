...
# F O R M A T O
#
if (! holidays_categories_is_id($id)) {
...
# 
if (! holidays_categories_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $holidays_categories = new Holidays_categories();
    $holidays_categories->setHolidays_categories($id);

    include view("holidays_categories", "details");
