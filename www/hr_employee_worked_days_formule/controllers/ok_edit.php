...
if (! $error ) {
    ...
    hr_employee_worked_days_formule_edit(
        $id ,  $employee_id ,  $month ,  $year ,  $column ,  $value ,  $formule ,  $notes ,  $code ,  $date_registre ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 4:
            header("Location: index.php?c=hr_employee_worked_days_formule&a=details&id=$lastInsertId");
            break;
            

        case 5: // custom
            // ejemplo index.php?c=hr_employee_worked_days_formule&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
