...
# 
if (! hr_employee_worked_days_formule_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_worked_days_formule = new Hr_employee_worked_days_formule();
    $hr_employee_worked_days_formule->setHr_employee_worked_days_formule($id);

    include view("hr_employee_worked_days_formule", "details");
