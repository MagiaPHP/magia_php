...
$section_father = (isset($_POST["section_father"]) && $_POST["section_father"] != "" && $_POST["section_father"] != "null" ) ? clean($_POST["section_father"]) : null;
...
################################################################################
if (!$error) {
    $lastInsertId = services_sections_add(
            $section_father, $code, $section, $order_by, $status
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=services_sections&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
