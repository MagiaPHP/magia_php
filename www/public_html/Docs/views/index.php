...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/fonts/font-awesome-4.3.0/css/font-awesome.min.css">
        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/css/stroke.css">
        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/css/bootstrap.css">
        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/css/animate.css">
        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/css/prettyPhoto.css">
        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/css/style.css">

        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/js/syntax-highlighter/styles/shCore.css" media="all">
        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/js/syntax-highlighter/styles/shThemeRDark.css" media="all">

        <!-- CUSTOM -->
        <link rel="stylesheet" type="text/css" href="www/public_html/Docs/views/css/custom.css">
                            ...
                            <ul class="nav">
                                ...
                                <li><a href="#line7">How to Use Option Panel</a>
                                    <ul class="nav">
                                        ...
                                        <li><a href="#line7_7">Quito</a>

                                            <ul class="nav">
                                                <li><a href="#line7_1_1">Conocoto</a></li>
                                ...
                                <?php
                                foreach (blog_categories_list_without_father() as $key => $category) {
                                    echo '<li><a href="#line1' . $category['id'] . '">' . $category['name'] . '</a>';

                                    $subcategories = blog_categories_list_by_father_id($category['id']);

                                    if ($subcategories) {

                                        echo '<ul class="nav">';
                                        foreach ($subcategories as $key => $sub_cat) {
                                            echo '<li><a href="#line1' . $category['id'] . '_' . $sub_cat['id'] . '">' . $sub_cat['name'] . '</a></li>';
                                        }
                                        echo '</ul>';
                                    }
                                ...
                                <li><a href="#line900"><?php _t("Admin"); ?></a></li>
                            </ul>
                        </nav >
                    </div>
                    <div class="col-md-9">
                        ...
                        <section id="line7" class="section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h4 id="line7_1_1">Quito General Options - </h4>
                                    <p>Lorem the It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. long established fact that a reader will English.</p>
                                </div>
                                <!-- end col -->
                            </div>
                        ...
                        <?php
                        foreach (blog_categories_list_without_father() as $key => $category) {
                            //  echo '<li><a href="#line1' . $category['id'] . '">' . $category['name'] . '</a></li>';

                            $categories = blog_categories_list_by_father_id($category['id']);

                            echo '
                        
                        

                        <section id="line1' . $category['id'] . '" class="section">

                            <div class="row">
                                <div class="col-md-12 left-align">
                                    <h2 class="dark-text">' . $category['id'] . ' ' . $category['name'] . ' <hr></h2>
                                    ';

                            foreach (blog_search_by_category($category['id']) as $key => $article) {
                                include view('public_html', 'template_1');
                            }
                            ...
                            if ($categories) {
                                ...
                                foreach ($categories as $key => $sub_cat) {
                                ...
                                <div class="col-md-12">
                                    <h4 id="line1' . $category['id'] . '_' . $sub_cat['id'] . '"> ' . $category['id'] . '_' . $sub_cat['id'] . ' ' . $sub_cat['name'] . '</h4>
                                    <p>' . $sub_cat['description'] . '</p>
                                </div>';

                                    foreach (blog_search_by_category($sub_cat['id']) as $key => $article) {
                                        include view('public_html', 'template_2');
                                    }
...
//                                    }
                        ...
                        <section id="line900" class="section">

                            <div class="row">
                                <div class="col-md-12 left-align">
                                    <h2 class="dark-text">Admin <hr></h2>
                                </div>
        ...
        <script src="www/public_html/Docs/views/js/jquery.min.js"></script>
        <script src="www/public_html/Docs/views/js/bootstrap.min.js"></script>
        <script src="www/public_html/Docs/views/js/retina.js"></script>
        <script src="www/public_html/Docs/views/js/jquery.fitvids.js"></script>
        <script src="www/public_html/Docs/views/js/wow.js"></script>
        <script src="www/public_html/Docs/views/js/jquery.prettyPhoto.js"></script>

        <!-- CUSTOM PLUGINS -->
        <script src="www/public_html/Docs/views/js/custom.js"></script>
        <script src="www/public_html/Docs/views/js/main.js"></script>

        <script src="www/public_html/Docs/views/js/syntax-highlighter/scripts/shCore.js"></script>
        <script src="www/public_html/Docs/views/js/syntax-highlighter/scripts/shBrushXml.js"></script>
        <script src="www/public_html/Docs/views/js/syntax-highlighter/scripts/shBrushCss.js"></script>
        <script src="www/public_html/Docs/views/js/syntax-highlighter/scripts/shBrushJScript.js"></script>
