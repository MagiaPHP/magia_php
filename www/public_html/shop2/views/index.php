...
<html lang="en" class="h-100">
    <head>
        ...
        <link href="www/public_html/shop2/views/css/cover.css" rel="stylesheet">
    </head>
    <body class="d-flex h-100 text-center text-white bg-dark">
        ...
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            <header class="mb-auto">
                <div>
                    ...
                    <nav class="nav nav-masthead justify-content-center float-md-end">
                        ...
                        <a class="nav-link" href="index.php?c=public_html&a=search">Search</a>
                    </nav>
                </div>
            </header>
            ...
            <main class="px-3">
                ...
                <p class="lead">
                    <a href="index.php?c=public_html&a=search" class="btn btn-lg btn-secondary fw-bold border-white bg-white">Learn more</a>
                </p>
            </main>
