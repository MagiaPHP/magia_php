...
$config['email'] = "contact@factux.be";
;
$config['url'] = "www.factux.be";
;
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <meta name="description" content="Factux.be">
        <meta name="author" content="factux.be">


        <meta property="og:site_name" content="factux.be" />
        <meta property="og:site" content="https://factux;be" />
        <meta property="og:title" content="Factux.be"/>
        <meta property="og:description" content="Factux.be" />
        <meta property="og:image" content="" /> <?php /* <!-- image link, make sure it's jpg --> */ ?>
        <meta property="og:url" content="" /> <?php /* <!-- where do you want your post to link to --> */ ?>
        <meta property="og:type" content="article" />


        <title>Factux.be</title>


        <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,700&display=swap&subset=latin-ext" rel="stylesheet">

        <link href="www/public_html/factux/views/css/bootstrap.css" rel="stylesheet">
        <link href="www/public_html/factux/views/css/fontawesome-all.css" rel="stylesheet">
        <link href="www/public_html/factux/views/css/swiper.css" rel="stylesheet">
        <link href="www/public_html/factux/views/css/magnific-popup.css" rel="stylesheet">
        <link href="www/public_html/factux/views/css/styles.css" rel="stylesheet">
        <link rel="icon" href="www/public_html/factux/views/images/favicon.png">
    ...
    <body data-spy="scroll" data-target=".fixed-top">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-5">
                            <div class="text-container">
                                <h1>Factux</h1>
                                <p class="p-large">
                                    Everything an entrepreneur needs to manage his company
                                </p>
                                <a class="btn-solid-lg page-scroll" href="sign-up.php">
                                    <?php echo strtoupper(_tr("Sign up")); ?>
                                </a>
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="image-container">
                                <div class="img-wrapper">
                                    <img
                                        class="img-fluid"
                                        src="www/public_html/factux/views/images/header-software-app.png"
                                        alt="alternative">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="swiper-container image-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img
                                            class="img-fluid"
                                            src="www/public_html/factux/views/images/customer-logo-1.png"
                                            alt="alternative">
                                    </div>
                                    <div class="swiper-slide">
                                        <img
                                            class="img-fluid"
                                            src="www/public_html/factux/views/images/customer-logo-2.png"
                                            alt="alternative">
                                    </div>
                                    <div class="swiper-slide">
                                        <img
                                            class="img-fluid"
                                            src="www/public_html/factux/views/images/customer-logo-3.png"
                                            alt="alternative">
                                    </div>
                                    <div class="swiper-slide">
                                        <img
                                            class="img-fluid"
                                            src="www/public_html/factux/views/images/customer-logo-4.png"
                                            alt="alternative">
                                    </div>
                                    <div class="swiper-slide">
                                        <img
                                            class="img-fluid"
                                            src="www/public_html/factux/views/images/customer-logo-5.png"
                                            alt="alternative">
                                    </div>
                                    <div class="swiper-slide">
                                        <img
                                            class="img-fluid"
                                            src="www/public_html/factux/views/images/customer-logo-6.png"
                                            alt="alternative">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="cards-1">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="above-heading"><?php echo strtoupper(_tr("Description")); ?> </div>
                        <h2 class="h2-heading">
                            Management system for budgets, invoices, payments for your company
                        </h2>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-image">
                                <img
                                    class="img-fluid"
                                    src="www/public_html/factux/views/images/description-1.png"
                                    alt="alternative">
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">
                        ...
                        <div class="card">
                            <div class="card-image">
                                <img
                                    class="img-fluid"
                                    src="www/public_html/factux/views/images/description-2.png"
                                    alt="alternative">
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">
                        ...
                        <div class="card">
                            <div class="card-image">
                                <img
                                    class="img-fluid"
                                    src="www/public_html/factux/views/images/description-3.png"
                                    alt="alternative">
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h2 class="h2-heading">                            
                            <?php _t("Automated system"); ?>
                        </h2>
                        <p class="p-heading">
                            Manage your invoices, budgets, payments in an automated way and get more time to dedicate to your business
                        </p>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="tab-content" id="argoTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="image-container">
                                            <img class="img-fluid" src="www/public_html/factux/views/images/features-1.png" alt="alternative">
                            ...
                            <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="image-container">
                                            <img class="img-fluid" src="www/public_html/factux/views/images/features-2.png" alt="alternative">
                                        </div> <!-- end of image-container -->
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="text-container">
                            ...
                            <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="image-container">
                                            <img class="img-fluid" src="www/public_html/factux/views/images/features-3.png" alt="alternative">
                                        </div> <!-- end of image-container -->
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="text-container">
        ...
        <div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="image-container">
                            <img class="img-fluid" src="www/public_html/factux/views/images/details-lightbox.png" alt="alternative">
                        </div> <!-- end of image-container -->
                    </div>
                    <div class="col-lg-4">
                        <h3>List Building</h3>
        ...
        <div id="details" class="basic-1">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="www/public_html/factux/views/images/details.png" alt="alternative">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="image-container">
                            <div class="video-wrapper">
                                <a class="popup-youtube" href="https://www.youtube.com/watch?v=i0f_LSP_agA" data-effect="fadeIn">
                                    <img class="img-fluid" src="www/public_html/factux/views/images/video-image.png" alt="alternative">
        ...
        <div id="pricing" class="cards-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="above-heading"><?php _t("PRICING"); ?></div>
                        <h2 class="h2-heading"><?php _t("Pricing Options Table"); ?></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title"><?php _t("BASIC"); ?></div>
                                <div class="price"><span class="currency">$</span><span class="value">Free</span></div>
                                <div class="frequency"><?php _t("forever"); ?></div>
                                <div class="divider"></div>

                                <ul class="list-unstyled li-space-lg">

                                    <li class="media">
                                        <i class="fas fa-check"></i><div class="media-body"><?php _t("Budgets"); ?></div>
                                    </li>                                                                        
                                    <li class="media">
                                        <i class="fas fa-check"></i><div class="media-body"><?php _t("Invoices"); ?></div>
                                    </li>                                                                        
                                    <li class="media">
                                        <i class="fas fa-check"></i><div class="media-body"><?php _t("Credit notes"); ?></div>
                                    </li>                                                                        
                                    <li class="media">
                                        <i class="fas fa-check"></i><div class="media-body"><?php _t("Payments"); ?></div>
                                    </li>                                                                                                                                                                                                                             
                                    <li class="media">
                                        <i class="fas fa-times"></i><div class="media-body"><?php _t("Reminders"); ?></div>
                                    </li>                                    
                                    <li class="media">
                                        <i class="fas fa-times"></i><div class="media-body"><?php _t("Products"); ?></div>
                                    </li>                                    
                                    <li class="media">
                                        <i class="fas fa-times"></i><div class="media-body"><?php _t("Multi user"); ?></div>
                                    </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title"><?php _t("AVANCED"); ?></div>
                                <div class="price"><span class="currency">$</span><span class="value">29.99</span></div>
                                <div class="frequency"><?php _t("monthly"); ?></div>
                                <div class="divider"></div>
                                <ul class="list-unstyled li-space-lg">
                                    ...
                                    <li class="media">
                                        <i class="fas fa-check"></i><div class="media-body"><?php _t("Reminders"); ?></div>
                                    </li>                                    
                                    <li class="media">
                                        <i class="fas fa-times"></i><div class="media-body"><?php _t("Products"); ?></div>
                                    </li>                                    
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-title"><?php _t("COMPLETE"); ?></div>
                                ...
                                <ul class="list-unstyled li-space-lg">
                                    ...
                                    <li class="media">
                                        <i class="fas fa-check"></i><div class="media-body"><?php _t("Products"); ?></div>
                                    </li>                                    
                                    <li class="media">
                                        <i class="fas fa-check"></i><div class="media-body"><?php _t("Multi user"); ?></div>
                                    </li>
                                </ul>
                                <div class="button-wrapper">
                                    <a class="btn-solid-reg page-scroll" href="sign-up.php">SIGN UP</a>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="image-wrapper">
                                            <img class="img-fluid" src="www/public_html/factux/views/images/testimonial-1.jpg" alt="alternative">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="image-wrapper">
                                            <img class="img-fluid" src="www/public_html/factux/views/images/testimonial-2.jpg" alt="alternative">
                                        </div> <!-- end of image-wrapper -->
                                        <div class="text-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="image-wrapper">
                                            <img class="img-fluid" src="www/public_html/factux/views/images/testimonial-3.jpg" alt="alternative">
                                        </div> <!-- end of image-wrapper -->
                                        <div class="text-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="image-wrapper">
                                            <img class="img-fluid" src="www/public_html/factux/views/images/testimonial-4.jpg" alt="alternative">
                                        </div> <!-- end of image-wrapper -->
                                        <div class="text-wrapper">
                        ...
                        <div class="text-container">
                            ...
                            <form id="newsletterForm" data-toggle="validator" data-focus="false">
                                ...
                                <div class="form-group checkbox">
                                    <input type="checkbox" id="nterms" value="Agreed-to-Terms" required>I've read and agree to Tivo's written <a href="privacy-policy.php">Privacy Policy</a> and <a href="terms-conditions.php">Terms Conditions</a>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
        ...
        <!-- Footer -->
        <svg class="footer-frame" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1920 79"><defs><style>.cls-2{
                fill:#5f4def;
                        ...
                        <div class="footer-col last">
                            ...
                            <ul class="list-unstyled li-space-lg p-small">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <a class="white" href="mailto:<?php echo $config['email']; ?>">
                                            <?php echo $config['email']; ?>
                                        </a>
                                        <i class="fas fa-globe"></i>
                                        <a class="white" href="<?php echo $config['url']; ?>">
                                            <?php echo $config['url']; ?>
                                        </a>
                                    </div>
                                </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <p class="p-small">
                            ...
                            <a href="https://factux.be">Factux.be</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- Scripts -->
        <script src="www/public_html/factux/views/js/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
        <script src="www/public_html/factux/views/js/popper.min.js"></script> <!-- Popper tooltip library for Bootstrap -->
        <script src="www/public_html/factux/views/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
        <script src="www/public_html/factux/views/js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
        <script src="www/public_html/factux/views/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
        <script src="www/public_html/factux/views/js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
        <script src="www/public_html/factux/views/js/validator.min.js"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
        <script src="www/public_html/factux/views/js/scripts.js"></script> <!-- Custom scripts -->
    </body>
</html>