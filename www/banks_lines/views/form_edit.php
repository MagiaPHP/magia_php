...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="operation" class="form-control" id="operation" placeholder="operation"  value="<?php echo $banks_lines->getOperation(); ?>" >
        </div>	
    </div>
    <?php # /operation ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="description" class="form-control" id="description" placeholder="description - textarea" ><?php echo $banks_lines->getDescription(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="total" class="form-control" id="total" placeholder="total"   value="<?php echo $banks_lines->getTotal(); ?>" >
        </div>	
    </div>
    <?php # /total ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_value" class="form-control" id="date_value" placeholder="date_value"  value="<?php echo $banks_lines->getDate_value(); ?>" >
        </div>	
    </div>
    <?php # /date_value ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="account_sender" class="form-control" id="account_sender" placeholder="account_sender"  value="<?php echo $banks_lines->getAccount_sender(); ?>" >
        </div>	
    </div>
    <?php # /account_sender ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="details" class="form-control" id="details" placeholder="details - textarea" ><?php echo $banks_lines->getDetails(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="message" class="form-control" id="message" placeholder="message - textarea" ><?php echo $banks_lines->getMessage(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="id_office" class="form-control" id="id_office" placeholder="id_office - textarea" ><?php echo $banks_lines->getId_office(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="office_name" class="form-control" id="office_name" placeholder="office_name - textarea" ><?php echo $banks_lines->getOffice_name(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="value_bankCheck_transaction" class="form-control" id="value_bankCheck_transaction" placeholder="value_bankCheck_transaction - textarea" ><?php echo $banks_lines->getValue_bankCheck_transaction(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="countable_balance" class="form-control" id="countable_balance" placeholder="countable_balance - textarea" ><?php echo $banks_lines->getCountable_balance(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="suffix_account" class="form-control" id="suffix_account" placeholder="suffix_account - textarea" ><?php echo $banks_lines->getSuffix_account(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="sequential" class="form-control" id="sequential" placeholder="sequential - textarea" ><?php echo $banks_lines->getSequential(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="available_balance" class="form-control" id="available_balance" placeholder="available_balance - textarea" ><?php echo $banks_lines->getAvailable_balance(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="debit" class="form-control" id="debit" placeholder="debit - textarea" ><?php echo $banks_lines->getDebit(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="credit" class="form-control" id="credit" placeholder="credit - textarea" ><?php echo $banks_lines->getCredit(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref" class="form-control" id="ref" placeholder="ref - textarea" ><?php echo $banks_lines->getRef(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref2" class="form-control" id="ref2" placeholder="ref2 - textarea" ><?php echo $banks_lines->getRef2(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref3" class="form-control" id="ref3" placeholder="ref3 - textarea" ><?php echo $banks_lines->getRef3(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref4" class="form-control" id="ref4" placeholder="ref4 - textarea" ><?php echo $banks_lines->getRef4(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref5" class="form-control" id="ref5" placeholder="ref5 - textarea" ><?php echo $banks_lines->getRef5(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref6" class="form-control" id="ref6" placeholder="ref6 - textarea" ><?php echo $banks_lines->getRef6(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref7" class="form-control" id="ref7" placeholder="ref7 - textarea" ><?php echo $banks_lines->getRef7(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref8" class="form-control" id="ref8" placeholder="ref8 - textarea" ><?php echo $banks_lines->getRef8(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref9" class="form-control" id="ref9" placeholder="ref9 - textarea" ><?php echo $banks_lines->getRef9(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="ref10" class="form-control" id="ref10" placeholder="ref10 - textarea" ><?php echo $banks_lines->getRef10(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_registre" class="form-control" id="date_registre" placeholder="date_registre"  required=""  value="<?php echo $banks_lines->getDate_registre(); ?>" >
        </div>	
    </div>
    <?php # /date_registre ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="code" class="form-control" id="code" placeholder="code - textarea" ><?php echo $banks_lines->getCode(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $banks_lines->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
