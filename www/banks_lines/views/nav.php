  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <?php include view("banks_lines", "form_search"   , $arg = ["redi" => 1]) ?>
            ...
            <ul class="nav navbar-nav">
                <li><a href="index.php?c=banks_lines&a=search_advanced"><?php _t("Search avanced"); ?></a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="index.php?c=banks_lines&a=export_json"><?php _t("Json"); ?></a></li>
                        <li><a href="index.php?c=banks_lines&a=export_pdf"><?php _t("Pdf"); ?></a></li>
                        <li><a href="index.php?c=banks_lines&a=export_csv"><?php _t("CSV"); ?></a></li>
                        <li><a href="index.php?c=banks_lines&a=export_xml"><?php _t("XML"); ?></a></li>
