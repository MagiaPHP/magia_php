...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="docu_id" class="form-control" id="docu_id" placeholder="docu_id"   required=""  value="<?php echo $docu_blocs->getDocu_id(); ?>" >
        </div>	
    </div>
    <?php # /docu_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="bloc" class="form-control" id="bloc" placeholder="bloc"  value="<?php echo $docu_blocs->getBloc(); ?>" >
        </div>	
    </div>
    <?php # /bloc ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="post" class="form-control" id="post" placeholder="post - textarea" ><?php echo $docu_blocs->getPost(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $docu_blocs->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
