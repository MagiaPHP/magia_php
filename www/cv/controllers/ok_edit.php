...
if (! $error ) {
    ...
    cv_edit(
        $id ,  $first_name ,  $last_name ,  $address ,  $city ,  $postal_code ,  $phone_number ,  $email ,  $driver_license ,  $birth_date ,  $availability ,  $professional_goal ,  $summary ,  $hobbies ,  $created_at ,  $work_experience ,  $education ,  $technologies ,  $skills ,  $projects ,  $languages ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=cv&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
