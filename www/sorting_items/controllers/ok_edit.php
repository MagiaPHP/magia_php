...
$position_order = (isset($_REQUEST["position_order"]) && $_REQUEST["position_order"] !="") ? clean($_REQUEST["position_order"]) : false;
...
if (! $error ) {
    ...
    sorting_items_edit(
        $id ,  $title ,  $description ,  $position_order    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=sorting_items&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
