...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="expense_id"><?php _t(ucfirst("expense_id")); ?>  * </label>
        <div class="col-sm-8">               <select name="expense_id" class="form-control selectpicker" id="expense_id" data-live-search="true" >
                ...
                expenses_select("id", array("id"), "" , array()); ?>                        
                </select>
</div>
    </div>
    <!-- mg_end expense_id -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">            <input type="text" name="discounts_mode" class="form-control" id="discounts_mode" placeholder="discounts_mode"  value="" >
</div>
    </div>
