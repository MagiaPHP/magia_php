...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="expense_id"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # budget_id ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="budget_id"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # category_code ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="category_code"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # code ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="code"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # quantity ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="quantity"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # description ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="description"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # price ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="price"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # discounts ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="discounts"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # discounts_mode ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="discounts_mode"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # tax ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="tax"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # order_by ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="order_by"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # status ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="status"><?php _t("Expenses lines"); ?></label>
        <div class="col-sm-8">
