<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="bank" class="form-control" id="bank" placeholder="bank" value="<?php echo $banks->getBank(); ?>" >
        </div>	
    </div>
    <?php # /bank ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="account_number" class="form-control" id="account_number" placeholder="account_number" value="<?php echo $banks->getAccount_number(); ?>" >
        </div>	
    </div>
    <?php # /account_number ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="bic" class="form-control" id="bic" placeholder="bic" value="<?php echo $banks->getBic(); ?>" >
        </div>	
    </div>
    <?php # /bic ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="iban" class="form-control" id="iban" placeholder="iban" value="<?php echo $banks->getIban(); ?>" >
        </div>	
    </div>
    <?php # /iban ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="code" class="form-control" id="code" placeholder="code" value="<?php echo $banks->getCode(); ?>" >
        </div>	
    </div>
    <?php # /code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="codification" class="form-control" id="codification" placeholder="codification" value="<?php echo $banks->getCodification(); ?>" >
        </div>	
    </div>
    <?php # /codification ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="delimiter" class="form-control" id="delimiter" placeholder="delimiter" value="<?php echo $banks->getDelimiter(); ?>" >
        </div>	
    </div>
    <?php # /delimiter ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="date_format" class="form-control" id="date_format" placeholder="date_format" value="<?php echo $banks->getDate_format(); ?>" >
        </div>	
    </div>
    <?php # /date_format ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="thousands_separator" class="form-control" id="thousands_separator" placeholder="thousands_separator" value="<?php echo $banks->getThousands_separator(); ?>" >
        </div>	
    </div>
    <?php # /thousands_separator ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="decimal_separator" class="form-control" id="decimal_separator" placeholder="decimal_separator" value="<?php echo $banks->getDecimal_separator(); ?>" >
        </div>	
    </div>
    <?php # /decimal_separator ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $banks->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
