...
if (!$error) {
    ...
    _options_push("config_providers_pagination_items_limit", $data, "providers");
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=providers&a=ok_pagination_items_limit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
