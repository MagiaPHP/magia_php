...
if (! $error ) {
    ...
    products_groups_edit(
        $id ,  $father_code ,  $code ,  $name ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=products_groups&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
