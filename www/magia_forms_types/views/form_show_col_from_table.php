...
<form method="post" action="index.php">
    ...
    <table class="table table-bordered">
        ...
        <?php
//            $checked_array = json_decode(_options_option("config_magia_forms_types_show_col_from_table"), true);
//            foreach (magia_forms_types_db_col_list_from_table($c) as $th) {
...
//            "button_save",
        ...
        $checked_array = json_decode(_options_option("config_magia_forms_types_show_col_from_table"), true)['cols'];
