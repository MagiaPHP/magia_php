...
# 
if (! magia_forms_types_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $magia_forms_types = new Magia_forms_types();
    $magia_forms_types->setMagia_forms_types($id);

    include view("magia_forms_types", "details");
