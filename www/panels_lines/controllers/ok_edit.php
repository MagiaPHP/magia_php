...
if (! $error ) {
    ...
    panels_lines_edit(
        $id ,  $panel_id ,  $icon ,  $label ,  $translate ,  $url ,  $badge ,  $controller ,  $action ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=panels_lines&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
