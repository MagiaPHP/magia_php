...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="icon" class="form-control" id="icon" placeholder="icon"  value="<?php echo $panels_lines->getIcon(); ?>" >
        </div>	
    </div>
    <?php # /icon ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="label" class="form-control" id="label" placeholder="label"  required=""  value="<?php echo $panels_lines->getLabel(); ?>" >
        </div>	
    </div>
    <?php # /label ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="url" class="form-control" id="url" placeholder="url - textarea" ><?php echo $panels_lines->getUrl(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="badge" class="form-control" id="badge" placeholder="badge"  value="<?php echo $panels_lines->getBadge(); ?>" >
        </div>	
    </div>
    <?php # /badge ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="controller" class="form-control" id="controller" placeholder="controller"  value="<?php echo $panels_lines->getController(); ?>" >
        </div>	
    </div>
    <?php # /controller ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="action" class="form-control" id="action" placeholder="action"  value="<?php echo $panels_lines->getAction(); ?>" >
        </div>	
    </div>
    <?php # /action ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $panels_lines->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
