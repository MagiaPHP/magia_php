...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="panel_id"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # icon ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="icon"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # label ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="label"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # translate ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="translate"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # url ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="url"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # badge ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="badge"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # controller ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="controller"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # action ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="action"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # order_by ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="order_by"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # status ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="status"><?php _t("Panels lines"); ?></label>
        <div class="col-sm-8">
