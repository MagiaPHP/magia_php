...
if (! $error ) {
    ...
    veh_vehicle_insurances_edit(
        $id ,  $vehicle_id ,  $insurance_code ,  $date_start ,  $date_end ,  $contrat_number ,  $countries_ok ,  $order_by ,  $status    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicle_insurances&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
