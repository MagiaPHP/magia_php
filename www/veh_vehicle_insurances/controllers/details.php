...
# F O R M A T O
#
if (! veh_vehicle_insurances_is_id($id)) {
...
# 
if (! veh_vehicle_insurances_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $veh_vehicle_insurances = new Veh_vehicle_insurances();
    $veh_vehicle_insurances->setVeh_vehicle_insurances($id);

    include view("veh_vehicle_insurances", "details");
