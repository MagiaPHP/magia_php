...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <?php # insurance_code ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="insurance_code"><?php _t("Insurance code"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # contrat_number ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="contrat_number"><?php _t("Contrat number"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # countries_ok ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="countries_ok"><?php _t("Countries ok"); ?></label>
        <div class="col-sm-8">
