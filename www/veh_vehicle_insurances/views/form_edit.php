...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="insurance_code" class="form-control" id="insurance_code" placeholder="insurance_code"  required=""  value="<?php echo $veh_vehicle_insurances->getInsurance_code(); ?>" >
        </div>	
    </div>
    <?php # /insurance_code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_start" class="form-control" id="date_start" placeholder="date_start"  required=""  value="<?php echo $veh_vehicle_insurances->getDate_start(); ?>" >
        </div>	
    </div>
    <?php # /date_start ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_end" class="form-control" id="date_end" placeholder="date_end"  required=""  value="<?php echo $veh_vehicle_insurances->getDate_end(); ?>" >
        </div>	
    </div>
    <?php # /date_end ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="contrat_number" class="form-control" id="contrat_number" placeholder="contrat_number"  required=""  value="<?php echo $veh_vehicle_insurances->getContrat_number(); ?>" >
        </div>	
    </div>
    <?php # /contrat_number ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="countries_ok" class="form-control" id="countries_ok" placeholder="countries_ok - textarea" ><?php echo $veh_vehicle_insurances->getCountries_ok(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $veh_vehicle_insurances->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
