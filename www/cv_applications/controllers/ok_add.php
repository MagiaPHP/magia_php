...
if (!$error) {
    $lastInsertId = cv_applications_add(
        $job_id ,  $applicant_name ,  $applicant_email ,  $application_date ,  $resume ,  $cover_letter ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=cv_applications&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
