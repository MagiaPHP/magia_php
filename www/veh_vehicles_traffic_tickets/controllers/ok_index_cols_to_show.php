...
if (!$error) {
    ...
    _options_push("veh_vehicles_traffic_tickets_index_cols_to_show", json_encode($data), "veh_vehicles_traffic_tickets");
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicles_traffic_tickets&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
