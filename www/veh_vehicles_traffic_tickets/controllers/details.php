...
# F O R M A T O
#
if (! veh_vehicles_traffic_tickets_is_id($id)) {
...
# 
if (! veh_vehicles_traffic_tickets_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $veh_vehicles_traffic_tickets = new Veh_vehicles_traffic_tickets();
    $veh_vehicles_traffic_tickets->setVeh_vehicles_traffic_tickets($id);

    include view("veh_vehicles_traffic_tickets", "details");
