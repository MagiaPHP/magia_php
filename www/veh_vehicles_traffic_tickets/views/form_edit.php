...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date" class="form-control" id="date" placeholder="date"  required=""  value="<?php echo $veh_vehicles_traffic_tickets->getDate(); ?>" >
        </div>	
    </div>
    <?php # /date ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="time" class="form-control" id="time" placeholder="time"  value="<?php echo $veh_vehicles_traffic_tickets->getTime(); ?>" >
        </div>	
    </div>
    <?php # /time ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="pv_police" class="form-control" id="pv_police" placeholder="pv_police"  required=""  value="<?php echo $veh_vehicles_traffic_tickets->getPv_police(); ?>" >
        </div>	
    </div>
    <?php # /pv_police ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_registre" class="form-control" id="date_registre" placeholder="date_registre"  required=""  value="<?php echo $veh_vehicles_traffic_tickets->getDate_registre(); ?>" >
        </div>	
    </div>
    <?php # /date_registre ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $veh_vehicles_traffic_tickets->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
