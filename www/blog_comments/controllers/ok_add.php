...
if (!$error) {
    $lastInsertId = blog_comments_add(
        $blog_id ,  $title ,  $comment ,  $author_id ,  $date ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=blog_comments&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
