...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="doc" class="form-control" id="doc" placeholder="doc"  required=""  value="<?php echo $doc_docs->getDoc(); ?>" >
        </div>	
    </div>
    <?php # /doc ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $doc_docs->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
