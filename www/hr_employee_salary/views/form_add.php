...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">            <input type="number" step="any" name="month" class="form-control" id="month" placeholder="month"   value="" >
</div>
    </div>
    <!-- mg_end month -->
    ...
    <!-- mg_start hour -->
    <div class="form-group">
        <label class="control-label col-sm-3" for="hour"><?php _t(ucfirst("hour")); ?> </label>
        <div class="col-sm-8">            <input type="number" step="any" name="hour" class="form-control" id="hour" placeholder="hour"   value="" >
</div>
    </div>
    <!-- mg_end hour -->
