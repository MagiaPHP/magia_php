...
if (!$error) {
    $lastInsertId = hr_employee_benefits_by_month_add(
        $employee_id ,  $year ,  $month ,  $benefit_code ,  $quantity ,  $price ,  $company_part ,  $employee_part ,  $company_part_value ,  $employee_part_value ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_employee_benefits_by_month&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
