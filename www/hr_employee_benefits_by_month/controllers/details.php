...
# 
if (! hr_employee_benefits_by_month_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_benefits_by_month = new Hr_employee_benefits_by_month();
    $hr_employee_benefits_by_month->setHr_employee_benefits_by_month($id);

    include view("hr_employee_benefits_by_month", "details");
