...
<form class="form-inline" method="post" action="index.php">
    ...
    <input type="hidden" name="option" value="hr_employee_benefits_by_month_pagination_items_limit">                                                         
    ...
    <div class="form-group">
        ...
        <div class="input-group">                    
            <input 
                ...
                name="data" 
                placeholder="" 
                value="<?php echo user_options("hr_employee_benefits_by_month_pagination_items_limit", $u_id); ?>"> 
