...
if (!$error) {
    $lastInsertId = cv_jobs_add(
        $job_title ,  $reference_number ,  $creation_date ,  $company_name ,  $location ,  $ciudad ,  $working_hours ,  $contract_type ,  $job_family ,  $job_description ,  $profile ,  $language_requirements ,  $employer_name ,  $contact_person ,  $application_mode ,  $website_url ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=cv_jobs&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
