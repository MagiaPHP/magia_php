...
<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="job_title"><?php _t("Job title"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="reference_number"><?php _t("Reference number"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # creation_date ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="creation_date"><?php _t("Creation date"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # company_name ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="company_name"><?php _t("Company name"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # working_hours ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="working_hours"><?php _t("Working hours"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # contract_type ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="contract_type"><?php _t("Contract type"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # job_family ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="job_family"><?php _t("Job family"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # job_description ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="job_description"><?php _t("Job description"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="language_requirements"><?php _t("Language requirements"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # employer_name ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="employer_name"><?php _t("Employer name"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # contact_person ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="contact_person"><?php _t("Contact person"); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="application_mode"><?php _t("Application mode"); ?></label>
        <div class="col-sm-8">
    ...
    <?php # website_url ?>
    <div class="form-group">
        <label class="control-label col-sm-3" for="website_url"><?php _t("Website url"); ?></label>
        <div class="col-sm-8">
