...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="plate" class="form-control" id="plate" placeholder="plate"  required=""  value="<?php echo $veh_vehicle_plates->getPlate(); ?>" >
        </div>	
    </div>
    <?php # /plate ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_start" class="form-control" id="date_start" placeholder="date_start"  value="<?php echo $veh_vehicle_plates->getDate_start(); ?>" >
        </div>	
    </div>
    <?php # /date_start ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_end" class="form-control" id="date_end" placeholder="date_end"  value="<?php echo $veh_vehicle_plates->getDate_end(); ?>" >
        </div>	
    </div>
    <?php # /date_end ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="old_plate" class="form-control" id="old_plate" placeholder="old_plate"  value="<?php echo $veh_vehicle_plates->getOld_plate(); ?>" >
        </div>	
    </div>
    <?php # /old_plate ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_registre" class="form-control" id="date_registre" placeholder="date_registre"  required=""  value="<?php echo $veh_vehicle_plates->getDate_registre(); ?>" >
        </div>	
    </div>
    <?php # /date_registre ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $veh_vehicle_plates->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
