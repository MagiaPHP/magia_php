...
if (!$error) {
    $lastInsertId = veh_vehicle_plates_add(
        $vehicle_id ,  $plate ,  $date_start ,  $date_end ,  $old_plate ,  $date_registre ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicle_plates&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
