...
# 
if (! hr_categories_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_categories = new Hr_categories();
    $hr_categories->setHr_categories($id);

    include view("hr_categories", "details");
