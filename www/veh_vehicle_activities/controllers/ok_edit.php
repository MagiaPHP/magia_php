...
if (! $error ) {
    ...
    veh_vehicle_activities_edit(
        $id ,  $vehicle_id ,  $driver_id ,  $start_date ,  $time_start ,  $kl_start ,  $end_date ,  $time_end ,  $kl_end ,  $order_by ,  $status ,  $kl_difference    
        );
...
switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=veh_vehicle_activities&a=ok_edit&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
