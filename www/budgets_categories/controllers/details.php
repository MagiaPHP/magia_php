...
# F O R M A T O
#
if (! budgets_categories_is_id($id)) {
...
# 
if (! budgets_categories_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $budgets_categories = new Budgets_categories();
    $budgets_categories->setBudgets_categories($id);

    include view("budgets_categories", "details");
