...
# 
if (! hr_work_status_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_work_status = new Hr_work_status();
    $hr_work_status->setHr_work_status($id);

    include view("hr_work_status", "details");
