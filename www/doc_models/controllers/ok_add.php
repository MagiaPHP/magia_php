...
if (!$error) {
    $lastInsertId = doc_models_add(
        $name ,  $description ,  $params ,  $author ,  $author_email ,  $url ,  $version ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=doc_models&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
