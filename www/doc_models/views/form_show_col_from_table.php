...
<form method="post" action="index.php">
    ...
    <table class="table table-bordered">
        ...
        <?php
//            $checked_array = json_decode(_options_option("config_doc_models_show_col_from_table"), true);
//            foreach (doc_models_db_col_list_from_table($c) as $th) {
...
//            "button_save",
        ...
        $checked_array = is_json($config_doc_models_show_col_json) ? json_decode($config_doc_models_show_col_json, true)['cols'] : [];


        //$checked_array = json_decode(_options_option("config_doc_models_show_col_from_table"), true)['cols'];
