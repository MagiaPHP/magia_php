...
if (!$error) {
    $lastInsertId = hr_employee_work_status_add(
        $employee_id ,  $work_status_code ,  $date_start ,  $date_end ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_employee_work_status&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
