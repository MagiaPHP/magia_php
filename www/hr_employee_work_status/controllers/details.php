...
# F O R M A T O
#
if (! hr_employee_work_status_is_id($id)) {
...
# 
if (! hr_employee_work_status_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_work_status = new Hr_employee_work_status();
    $hr_employee_work_status->setHr_employee_work_status($id);

    include view("hr_employee_work_status", "details");
