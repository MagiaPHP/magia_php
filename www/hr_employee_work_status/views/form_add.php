...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <!-- mg_start work_status_code -->
    <div class="form-group">
        <label class="control-label col-sm-3" for="work_status_code"><?php _t(ucfirst("work_status_code")); ?>  * </label>
        <div class="col-sm-8">               <select name="work_status_code" class="form-control selectpicker" id="work_status_code" data-live-search="true" >
                ...
                hr_work_status_select("code", array("code"), "" , array()); ?>                        
                </select>
</div>
    </div>
    <!-- mg_end work_status_code -->
