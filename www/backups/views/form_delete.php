<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date" class="form-control" id="date" placeholder="date" value="<?php echo $backups->getDate(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /date ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="subdomain" class="form-control" id="subdomain" placeholder="subdomain" value="<?php echo $backups->getSubdomain(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /subdomain ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $backups->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
