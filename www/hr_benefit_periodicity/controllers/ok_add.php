...
if (!$error) {
    $lastInsertId = hr_benefit_periodicity_add(
        $code ,  $periodicity ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_benefit_periodicity&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
