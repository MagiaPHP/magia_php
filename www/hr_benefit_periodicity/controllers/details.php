...
# F O R M A T O
#
if (! hr_benefit_periodicity_is_id($id)) {
...
# 
if (! hr_benefit_periodicity_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_benefit_periodicity = new Hr_benefit_periodicity();
    $hr_benefit_periodicity->setHr_benefit_periodicity($id);

    include view("hr_benefit_periodicity", "details");
