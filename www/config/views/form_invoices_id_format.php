<form class="form-inline" method="post" action="index.php">
    ...
    <input type="hidden" name="a" value="ok_invoices_id_format"> 
    ...
    <textarea class="form-control" name="data" id="" rows="5" cols="100"><?php echo _options_option('config_invoices_id_format'); ?></textarea>
