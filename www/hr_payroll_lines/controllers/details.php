...
# 
if (! hr_payroll_lines_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_payroll_lines = new Hr_payroll_lines();
    $hr_payroll_lines->setHr_payroll_lines($id);

    include view("hr_payroll_lines", "details");
