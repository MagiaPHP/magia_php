...
if (!$error) {
    $lastInsertId = hr_payroll_lines_add(
        $payroll_id ,  $code ,  $in_out ,  $days ,  $quantity ,  $value ,  $description ,  $formula ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_payroll_lines&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
