...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date" class="form-control" id="date" placeholder="date"  required=""  value="<?php echo $hr_employee_fines->getDate(); ?>" >
        </div>	
    </div>
    <?php # /date ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="description" class="form-control" id="description" placeholder="description - textarea" ><?php echo $hr_employee_fines->getDescription(); ?></textarea>    <script>
        ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="value" class="form-control" id="value" placeholder="value"   required=""  value="<?php echo $hr_employee_fines->getValue(); ?>" >
        </div>	
    </div>
    <?php # /value ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="way" class="form-control" id="way" placeholder="way"  required=""  value="<?php echo $hr_employee_fines->getWay(); ?>" >
        </div>	
    </div>
    <?php # /way ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_employee_fines->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
