...
if (!$error) {
    $lastInsertId = hr_employee_fines_add(
        $employee_id ,  $date ,  $category_code ,  $description ,  $value ,  $way ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_employee_fines&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
