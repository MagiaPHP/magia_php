...
# 
if (! hr_employee_fines_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_employee_fines = new Hr_employee_fines();
    $hr_employee_fines->setHr_employee_fines($id);

    include view("hr_employee_fines", "details");
