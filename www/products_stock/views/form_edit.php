<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="stock" class="form-control" id="stock" placeholder="stock" value="<?php echo $products_stock->getStock(); ?>" >
        </div>	
    </div>
    <?php # /stock ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="stock_min" class="form-control" id="stock_min" placeholder="stock_min" value="<?php echo $products_stock->getStock_min(); ?>" >
        </div>	
    </div>
    <?php # /stock_min ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="stock_max" class="form-control" id="stock_max" placeholder="stock_max" value="<?php echo $products_stock->getStock_max(); ?>" >
        </div>	
    </div>
    <?php # /stock_max ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $products_stock->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
