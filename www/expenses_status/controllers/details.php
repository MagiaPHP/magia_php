...
# 
if (! expenses_status_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $expenses_status = new Expenses_status();
    $expenses_status->setExpenses_status($id);

    include view("expenses_status", "details");
