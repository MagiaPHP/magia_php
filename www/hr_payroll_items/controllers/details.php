...
# 
if (! hr_payroll_items_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $hr_payroll_items = new Hr_payroll_items();
    $hr_payroll_items->setHr_payroll_items($id);

    include view("hr_payroll_items", "details");
