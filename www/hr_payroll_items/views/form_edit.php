...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="code" class="form-control" id="code" placeholder="code"  value="<?php echo $hr_payroll_items->getCode(); ?>" >
        </div>	
    </div>
    <?php # /code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="in_out" class="form-control" id="in_out" placeholder="in_out"  required=""  value="<?php echo $hr_payroll_items->getIn_out(); ?>" >
        </div>	
    </div>
    <?php # /in_out ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $hr_payroll_items->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
