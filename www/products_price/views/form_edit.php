<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="price" class="form-control" id="price" placeholder="price" value="<?php echo $products_price->getPrice(); ?>" >
        </div>	
    </div>
    <?php # /price ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_from" class="form-control" id="date_from" placeholder="date_from" value="<?php echo $products_price->getDate_from(); ?>" >
        </div>	
    </div>
    <?php # /date_from ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_to" class="form-control" id="date_to" placeholder="date_to" value="<?php echo $products_price->getDate_to(); ?>" >
        </div>	
    </div>
    <?php # /date_to ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $products_price->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
