...
if (!$error) {
    $lastInsertId = _menus_locations_add(
        $location ,  $label ,  $icon ,  $order_by ,  $status    
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=_menus_locations&a=ok_add&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
