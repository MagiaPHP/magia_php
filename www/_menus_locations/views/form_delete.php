...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="location" class="form-control" id="location" placeholder="location"  required=""  value="<?php echo $_menus_locations->getLocation(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /location ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="label" class="form-control" id="label" placeholder="label"  value="<?php echo $_menus_locations->getLabel(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /label ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="icon" class="form-control" id="icon" placeholder="icon"  value="<?php echo $_menus_locations->getIcon(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /icon ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   value="<?php echo $_menus_locations->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
