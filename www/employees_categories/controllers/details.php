...
# 
if (! employees_categories_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    $employees_categories = new Employees_categories();
    $employees_categories->setEmployees_categories($id);

    include view("employees_categories", "details");
