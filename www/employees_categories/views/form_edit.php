...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="category" class="form-control" id="category" placeholder="category"  required=""  value="<?php echo $employees_categories->getCategory(); ?>" >
        </div>	
    </div>
    <?php # /category ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $employees_categories->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
