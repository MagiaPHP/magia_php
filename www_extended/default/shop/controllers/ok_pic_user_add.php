...
if (!$error) {
    ...
    // 5119720211101171620.jpg
    // 5119720211101171653.png
//    vardump(user_options_search_by_user_option($contact_id, 'contacts_picture'));
...
//    die(); 
    ...
    switch ($redi) {
        ...
        case 4:
            header("Location: index.php?c=shop&a=offices_details&id=$contact_id");
            break;

        case 5:
            header("Location: index.php?c=shop&a=contacts_details&id=$contact_id");
            break;

        case 6:
            header("Location: index.php?c=shop&a=logo&id=$contact_id");
            break;
    ...
    $w = null;
    // $txt
    $description = "Error: Update pic [$data]";
    $doc_id = $u_id;
    $crud = "update";
    //$error = null ;
    $val_get = ( isset($_GET) ) ? json_encode($_GET) : null;
