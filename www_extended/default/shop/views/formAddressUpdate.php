    ...
    <?php } else { ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">  
                ...
                <input type="hidden" name="name" value="Delivery"> 
                <input type="text"  name="" class="form-control" id="" placeholder="" value="<?php echo $address['name']; ?>" readonly=""  >
            </div>
        </div>
