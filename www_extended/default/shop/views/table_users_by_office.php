...
<table class="table table-striped table-condensed table-bordered" >
    ...
    <tbody>                
        ...
        foreach ($users_by_office as $key => $ubo) {
            ...
            $lock = ( $ubo['status'] == 0 ) ? '<span class="glyphicon glyphicon-hourglass"></span> Wait' : "";
            $lock = ( $ubo['status'] == -1 ) ? '<i class="fas fa-lock"></i> Blocked' : "";
            ?>                                        
            <tr>

                <td><?php echo contacts_picture($ubo["contact_id"]); ?></td>
