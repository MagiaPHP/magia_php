<div class="panel panel-default">
    <div class="panel-heading"><b><?php _t("Right"); ?></b></div>
    <div class="panel-body">
        <?php
        foreach (shop_orders_lines($id, 'R') as $key => $item) {
            ...
            foreach ($items_array as $key => $value) {
                ...
                if ($key == 'options') {
                    ...
                    foreach ($value as $k => $op) {
                        echo "<tr><td class=\"text-right\">" . ucfirst(_tr("Option")) . "</td><td>" . options_field_id("option", $op) . "</td></tr>";
                        $i++;
                    }
                } else {
