...
<?php farra_progreso(13, $config_orders_total_steps); ?>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        ...
        <div class="row">  
            ...
            <script>
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    changeSrc();
                    updateImages("events", "event_id[L]", 'l');
                    updateImages("events", "event_id[R]", 'r');
                });
            </script>
            <form class="form-horizontal" method="post" action="index.php">
                <input type="hidden" name="c" value="shop">
                <input type="hidden" name="a" value="ok_order_new_event_add">
                ...
                if ($order['side'] == "R" || $order['side'] == "S") {
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">    
                        <?php order_new_form_events($type_r_id, "R", $event_r_id); ?>
                    </div> 
                <?php } ?> 
                ...
                if ($order['side'] == "L" || $order['side'] == "S") {
                    ...
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">                            
                        <?php order_new_form_events($type_l_id, "L", $event_l_id); ?>    
                    </div>
                <?php } ?>  
        ...
        <?php //include 'form_order_new_9010.php' ; ?>
    </div>
