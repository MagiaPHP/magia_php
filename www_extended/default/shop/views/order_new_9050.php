...
<?php farra_progreso(17, $config_orders_total_steps); ?>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        ...
        <?php ######################################################################## ?>
        <h1><?php _t("Select the constitution of the ear"); ?></h1>           
        ...
        <div class="row"> 
            ...
            <script>
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    changeSrc();
                    updateImages("constitution", "constitution_id[L]", 'l');
                    updateImages("constitution", "constitution_id[R]", 'r');
                });
            </script> 
            <form class="form-horizontal" method="post" action="index.php">
                <input type="hidden" name="c" value="shop">
                <input type="hidden" name="a" value="ok_order_new_con_add">
                ...
                if ($order['side'] == "R" || $order['side'] == "S") {
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">    
                        <?php order_new_form_con($type_r_id, "R", $constitution_r_id); ?>
                    </div> 
                <?php } ?>  
                ...
                if ($order['side'] == "L" || $order['side'] == "S") {
                    ...
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">                            
                        <?php order_new_form_con($type_l_id, "L", $constitution_l_id); ?>    
                    </div>
                <?php } ?>   
        ...
        <?php // include 'form_order_new_9050.php' ;   ?>
    </div>
