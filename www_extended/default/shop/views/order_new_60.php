...
<?php farra_progreso(9, $config_orders_total_steps); ?>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        ...
        <div class="row">
            ...
            <script>
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    changeSrc();
                    updateImages("couleurs", "colour_id[L]", 'l');
                    updateImages("couleurs", "colour_id[R]", 'r');
                });
            </script>
            ...
            <form class="form-horizontal" method="post" action="index.php">
                ...
                <input type="hidden" name="a" value="ok_order_new_couleur_add">
                ...
                if ($order['side'] == "R" || $order['side'] == "S") {
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">    
                        <?php order_new_form_colors($tmf_r_id, $material_r_id, "R", $colour_r_id); ?>
                    </div> 
                <?php } ?> 
                ...
                if ($order['side'] == "L" || $order['side'] == "S") {
                    ...
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">                            
                        <?php order_new_form_colors($tmf_l_id, $material_l_id, "L", $colour_l_id); ?>    
                    </div>
                <?php } ?>  
        ...
        <?php // include 'form_order_new_60.php' ; ?>
    </div>
