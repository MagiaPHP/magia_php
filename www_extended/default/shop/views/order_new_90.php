...
<?php farra_progreso(12, $config_orders_total_steps); ?>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        ...
        <div class="row">  
            ...
            <script>
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    changeSrc();
                    updateImages("ecouteurs", "ecouteur_id[L]", 'l');
                    updateImages("ecouteurs", "ecouteur_id[R]", 'r');
                });
            </script>
            <form class="form-horizontal" method="post" action="index.php">
                <input type="hidden" name="c" value="shop">
                <input type="hidden" name="a" value="ok_order_new_ecouteur_add">
                ...
                if ($order['side'] == "R" || $order['side'] == "S") {
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">    
                        <?php
                        order_new_form_ecouteurs($typeMarque_r_id, "R", $ecouteur_r_id);
                        //vardump($ecouteur_r_id); 
                        ?>    
                    </div> 
                <?php } ?>  
                ...
                if ($order['side'] == "L" || $order['side'] == "S") {
                    ...
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">                            
                        <?php order_new_form_ecouteurs($typeMarque_l_id, "L", $ecouteur_l_id);
                        ?>    
                    </div>
                <?php } ?>  
        ...
        <?php //include 'form_order_new_90.php' ; ?>
    </div>
