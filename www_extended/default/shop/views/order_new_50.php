...
<?php farra_progreso(8, $config_orders_total_steps); ?>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        ...
        <div class="row"> 
            ...
            <script>
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    changeSrc();
                    updateImages("materials", "material_id[L]", 'l');
                    updateImages("materials", "material_id[R]", 'r');
                });
            </script>
            ...
            <form class="form-horizontal" method="post" action="index.php">
                ...
                <input type="hidden" name="a" value="ok_order_new_material_add">
                ...
                if ($order['side'] == "R" || $order['side'] == "S") {
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">    
                        <?php order_new_form_materials($tmf_r_id, "R", $material_r_id); ?>
                    </div> 
                <?php } ?>  
                ...
                if ($order['side'] == "L" || $order['side'] == "S") {
                    ...
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">                            
                        <?php order_new_form_materials($tmf_l_id, "L", $material_l_id); ?>    
                    </div>
                <?php } ?> 
        ...
        <?php //include 'form_order_new_50.php' ; ?>
    </div>
