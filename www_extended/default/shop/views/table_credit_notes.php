...
<table class="table table-striped table-condensed table-bordered" >
    ...
    <tbody>
        ...
        foreach ($credit_notes as $credit_note) {
            ...
            <?php } ?>              
            <tr>
                <?php /* <td><a href="index.php?c=credit_notes&a=details&id=<?php echo "$credit_note[id]"; ?>"><?php echo "$credit_note[id]"; ?></a></td> */ ?>
                ...
                <td>
                    ...
                    <?php echo invoices_numberf($credit_note['invoice_id']); ?>


                    <?php
                    /*    <a href="index.php?c=invoices&a=details&id=<?php echo "$credit_note[invoice_id]"; ?>"><?php echo "$credit_note[invoice_id]"; ?></a>
                     */
                    ?>
                </td>
                ...
                <?php if (permissions_has_permission($u_rol, "shop_ddddddcredit_notes", "update")) { ?>
                    <td>
                        <a 
                ...
                <td>
                    ...
                    <a 
                        ...
                        href="index.php?c=shop&a=credit_notes_export_pdf&id=<?php echo "$credit_note[id]"; ?>&code=<?php echo "$credit_note[code]"; ?>" target="_print"
                        >
