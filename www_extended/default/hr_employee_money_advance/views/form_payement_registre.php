...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <input type="hidden" name="expense_id" value="<?php echo $hr_employee_money_advance->getId(); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input 
                ...
                id="total" 
                placeholder=""
                value="<?php echo ($hr_employee_money_advance->getTo_pay()) ?>"
                >
        </div>	
    </div>
    <?php # /total ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input 
                ...
                value="<?php echo $hr_employee_money_advance->getCe(); ?>" readonly="">
        </div>	
    </div>
    <?php # /ce ?>
