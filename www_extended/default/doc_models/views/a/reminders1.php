...
class PDF_REMINDERS1 extends A {
...
//        vardump($cell);
        ...
        ////////////////////////////////////////////////////////////////////
//        if ($SetTextColor) {
//            $this->SetTextColor($SetTextColor['r'], $SetTextColor['g'], $SetTextColor['b']);
//        }
//        if ($SetDrawColor) {
...
//        vardump($cell);
    ...
    function template($txt, $translate = true): string {
        ...
        $this->setTag("%date%", $this->getInvoice()->getDate(), 'Document date');
...
//            
//        $this->setTag("%total%", $this->getInvoice()->getTotal());  // suma de todas las facturas
