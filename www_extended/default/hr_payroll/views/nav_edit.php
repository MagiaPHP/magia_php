    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php?c=hr_payroll">
                ...
                <?php echo ( _options_option("config_menus_debug") ) ? _menus_get_file_name(__FILE__) : _t("Hr payroll edit"); ?>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
                <?php if (permissions_has_permission($u_rol, "conssssssfig", "update")) { ?>
                    <li>
                        <a 
                            data-toggle="modal" 
            ...
            <div class="collapse navbar-collapse" id="hr_payroll_add">
                ...
                <?php if (permissions_has_permission($u_rol, "hr_payroll", "read")) { ?>     

                    <a href="index.php?c=hr_payroll&a=details&id=<?php echo $hr_payroll->getId(); ?>" type="button" class="btn btn-primary navbar-btn navbar-right">
