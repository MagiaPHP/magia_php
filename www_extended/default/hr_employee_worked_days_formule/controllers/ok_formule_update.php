...
//    vardump(array(
//        $employee_id, $month, $year, $column, $formule
//    ));
//
//    die();
    ...
    hr_employee_worked_days_formule_push_formule_by($employee_id, $month, $year, $column, $formule);

    //
    //
    //
    //
    $id = hr_employee_worked_days_formule_get_field_by_employee_month_year_column('id', $employee_id, $month, $year, $column);
    $wd = new Employee_worked_days();
    $wd->setEmployee_worked_days($item['id'], $year, $month);
    ...
    switch ($redi["redi"]) {
        ...
        case 4:
            header("Location: index.php?c=hr_employee_worked_days&a=by_month#4");
            break;
