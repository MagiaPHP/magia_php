...
$id = (isset($_REQUEST["id"]) && $_REQUEST["id"] != "" ) ? clean($_REQUEST["id"]) : 1;
...
//    array_push($error, "Id is not in db");
//}
#################################################################################
#################################################################################
...
if (!$error) {
//    $updates = new Updates();
//    $updates->setUpdates($id);
    //vardump($updates->getCode_install());
    updates_execute_update();
    //include view("updates", "install");
