<?php
# Controller: updates
# Title: Cambios en tabla
# Description: Pone al dia la tabla updates
# date: 01-20-25
$update = "
...
CHANGE `installed` `installed` INT(1) NULL DEFAULT NULL, 
CHANGE `order_by` `order_by` INT(11) NOT NULL DEFAULT '1', 
