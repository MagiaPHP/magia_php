...
foreach ($tax_by_country as $key => $tax) {
    ...
    <tr>
        ...
        <td class="text-right"><?php
            ...
            echo " $tax[tax] %";
            ?></td>
        <td class="text-right"><?php echo monedaf(expenses_lines_total_by_tax($id, $tax['tax'])); ?></td>
        <td></td>
...
<tr>
    ...
    <td class="text-right" ><?php echo monedaf(expenses_field_id("advance", $id)); ?></td>
...
<tr>
    ...
    <td class="text-right info"><b><?php echo monedaf(($total_totaltvac + $transport_tvac ) - expenses_field_id("advance", $id)); ?></b></td>                                                
    <td></td>
    <td></td>
</tr>
