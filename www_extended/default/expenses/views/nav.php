...
# http://magiaphp.com 
# Fecha de creacion del documento: 2024-09-14 11:09:32 
#################################################################################
?>
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                <span class="sr-only">Toggle navigation expenses</span>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <?php
            if (IS_MULTI_VAT) {
                include view("expenses", "form_search_simple_multi");
            } else {
                include view('expenses', "form_search_simple");
            }
            ?>
            ...
            $menu_items = _menus_list_by_location_without_father('expenses_nav');
            ?>
                ...
                <?php if (!empty($menu_items)): ?>
                    <?php foreach ($menu_items as $item): ?>
                        <?php if (_menus_can_show($item['controller'])): ?>
                            <li>
                                <?= _menus_dropdown_create_html('expenses_nav', $item); ?>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php else: ?>
             ...
             *             <ul class="nav navbar-nav">
              ...
              <?php
              foreach (_menus_list_by_location('expenses_nav') as $key => $menu_item) {
              echo '<li><a href="index.php?c=expenses&a=search_advanced">' . $menu_item['label'] . '</a></li>';
              }
              ?>
