<table class="table table-striped table-bordered">
    ...
    <tbody>                     
        ...
        $i = 1;
        $total = 0;
        foreach (projects_inout_search_by('expense_id', $expense->getId()) as $key => $pro_list) {
            ...
            <tr class="<?php echo $class; ?>">
                ...
                <td class="">    
                    <?php if (1 == 1) { ?>
                        <?php include "modal_remove_expense.php"; ?>
                        <?php
                    } else {
    ...
    <tr>
        ...
        <td class="text-right"><?php echo moneda(projects_inout_total_by_expense_id($expense->getId())); ?></td>
        <td></td>
    </tr>
    ...
    <tr>
        ...
        <td class="text-right"><?php
            ...
            echo moneda(expenses_available_to_assign($expense->getId()));
            ?></td>
        <td></td>
    </tr>
    ...
    <form method="post" action="index.php">
        ...
        <input type="hidden" name="a" value="ok_add_expense">
        ...
        <tr>
            ...
            <td>
                <div class="form-group">
                    ...
                    <select 
                        class="form-control" 
                        name="project_id"
                        <?php echo (!projects_inout_list_without_expense_id($expense->getId()) || expenses_available_to_assign($expense->getId()) <= 0) ? 'disabled' : ''; ?>
                        >
                            <?php
                            // lista de proyecto que no esten con el expense id x
                            foreach (projects_inout_list_without_expense_id($expense->getId()) as $key => $pro_lit) {
            ...
            <td>
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="value" 
                        id="value" 
                        placeholder="<?php echo _t("Value max."); ?> : <?php echo expenses_available_to_assign($expense->getId()); ?>" 
                        required=""
                        value="<?php echo expenses_available_to_assign($expense->getId()); ?>"
            ...
            <td>
                ...
                <button type="submit" class="btn btn-default" <?php echo (!projects_inout_list_without_expense_id($expense->getId()) || expenses_available_to_assign($expense->getId()) <= 0 ) ? 'disabled' : ''; ?>  >
                    <?php echo icon("plus"); ?> 
                    <?php _t("Add"); ?>
                </button>
            </td>
