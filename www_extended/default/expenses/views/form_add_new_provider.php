...
<form class="form-horizontal" action ="index.php" method ="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">    
            <input type="text"  
                   ...
                   class="form-control" 
                   id="companyName" 
                   placeholder="<?php _t("Company SRL"); ?>" 
                   value=""
                   required=""
                   >
        </div>     
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">                
            ...
            <select class="form-control" name="country">
                ...
                foreach (countries_list() as $key => $value) {
                    ...
                    echo "<option value=\"$value[countryCode]\" $selected >" . utf8_decode($value['countryCode']) . " - " . utf8_decode($value['countryName']) . "</option>";
                }
                ?>
                <option value="null"><?php _t("No aplica"); ?></option>
            </select>
        ...
        <div class="col-sm-6">    
            <input 
                ...
                class="form-control" 
                id="tva" 
                placeholder="<?php _t("Company vat number"); ?>" 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">    
            <input 
                type="text"  
                name="number" 
                class="form-control" id="number" placeholder="<?php _t("Number"); ?>" required="">
        </div>
        <div class="col-sm-6">    
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">    
            <input type="text"  name="city" class="form-control" id="city" placeholder="<?php _t("City"); ?>" required="">
        </div>
    </div>
