        ...
        <?php if (modules_field_module('status', 'providers')) { ?>
            ...
            <?php if (count(providers_list()) > 0) { ?>
                <ul class="nav nav-tabs">
                    <li role="presentation"  class="active"><a href="index.php?c=expenses&a=add_provider"><?php _t('Add provider'); ?></a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <p><?php _t("New provider"); ?></p>

                    <?php
                    include "form_add_company.php";
                    ?>
