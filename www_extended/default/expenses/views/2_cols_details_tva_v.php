<tr>
    <td colspan='<?php echo count($cbects) - 8; ?>'>    
        ...
        <?php if (permissions_has_permission($u_rol, 'config', "update")) { ?>
            ...
            <a href="index.php?c=expenses&a=ok_2_cols_table_items_tva&data=h&redi[redi]=2&redi[id]=<?php echo $id; ?>"><?php echo icon("option-horizontal"); ?></a>    
        <?php } ?>
    </td>         
...
<tr>
    ...
    ?>
    <td class="text-right"><b><?php _t("Already paid"); ?></b></td>                                                
    <td colspan="0"class="text-right info"><b><?php echo moneda($expense->getAdvance()); ?></b></td>
...
<tr>
    ...
    <td colspan="0"class="text-right info"><b><?php echo moneda($expense->getTo_pay()); ?></b></td>
    <td></td>
