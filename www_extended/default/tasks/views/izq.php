<div class="list-group">
    ...
    foreach (tasks_status_list() as $tsl) {
        ...
        $icon = ($tsl['icon']) ? icon($tsl['icon']) : false;
        ...
        if ($tsl['code'] == 30 || $tsl['code'] == -10) {
            echo '<a href="index.php?c=tasks&a=search&w=by_status&status=' . $tsl['code'] . '" class="list-group-item">' . $icon . ' ' . _tr($tsl['name']) . '</a>';
        } else {
