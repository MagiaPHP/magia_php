...
$lang = (isset($_GET["lang"]) && ($_GET["lang"]) != "") ? clean($_GET["lang"]) : $u_language;
...
$pagination = new Pagination($page, _content_search_full($txt, $lang));

$pagination->setUrl('index.php?c=_content');

$_content = _content_search_full($txt, $pagination->getStart(), $pagination->getLimit());
