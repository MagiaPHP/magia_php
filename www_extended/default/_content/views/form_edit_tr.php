...
<form method="post" action="index.php">
    ...
    <div class="form-group">
        <label for="translation"><?php _t("Text to translate"); ?></label>
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="" id="" placeholder="" value="<?php echo $l ?>" readonly="">
    </div>
    ...
    <div class="form-group">
        ...
        <textarea 
            ...
            name="translation" 
            id="translation" 
            placeholder="Put your translations here" rows="5"><?php echo _translations_by_content_language($_content_item["frase"], $l); ?></textarea>
    </div>
