    ...
    <tbody>
        ...
        <tr>
            ...
            foreach ($_content as $_con) {
                ...
                $contexto = ($_con['contexto']) ? str_replace($txt, "<b class='text-primary'>$txt</b>", $_con['contexto']) : $_con['contexto'];
                $translation = str_replace($txt, "<b class='text-primary'>$txt</b>", $_con['translation']);
