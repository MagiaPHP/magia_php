CREATE TRIGGER `before_update_hr_employee_benefits_by_month` BEFORE UPDATE ON `hr_employee_benefits_by_month`
 FOR EACH ROW BEGIN
    DECLARE company_part_value DECIMAL(65, 6);
    DECLARE employee_part_value DECIMAL(65, 6);

    -- Copia los valores actualizados desde hr_employee_benefits a hr_employee_benefits_by_month
