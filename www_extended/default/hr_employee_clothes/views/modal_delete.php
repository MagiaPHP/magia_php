...
<div class="modal fade" id="hr_employee_clothes_delete_<?php echo $hr_employee_clothes_item['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="hr_employee_clothes_edit_Label">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="hr_employee_clothes_edit_Label"> <?php _t("Delete"); ?>
