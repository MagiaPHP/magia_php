...
$expenses_available_to_assign = expenses_available_to_assign($expense_id);

if ($value > $expenses_available_to_assign) {
...
if (!$error) {
    ...
    projects_inout_add_expense($project_id, $expense_id, $value);
