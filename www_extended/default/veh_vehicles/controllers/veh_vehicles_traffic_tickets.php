...
# 
if (! veh_vehicles_field_id("id", $id)) {
    array_push($error, "Id is mandatory");
}
#################################################################################
...
if (!$error) {
    ...
    $veh_vehicles = new Veh_vehicles();
    
    $veh_vehicles->setVeh_vehicles($id);
    
    vardump($veh_vehicles); 

//$veh_vehicles->getDriversList();
    

    include view("veh_vehicles", "veh_vehicles_traffic_tickets");
