<form class="form-inline" method="post" action="index.php">
    ...
    <input type="hidden" name="field" value="m_col_external">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="new_data">
            ...
            <?php
            $m_col_external_list = db_cols_from_table($fle2->getM_table_external());

            foreach ($m_col_external_list as $key => $col) {

                $selected = ($col['Field'] == $fle2->getM_col_external() ) ? " selected " : "";
