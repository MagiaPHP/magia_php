...
//
//        $mufl_icon = icon($mufl['location']) ?? '';
//
//       // echo '<a href="index.php?c=_menus&a=search&w=by_location&location=' . $mufl['location'] . '" class="list-group-item ' . $selected . '">' . $mufl_icon . ' ' . $mufl['location'] . '</a> ';
//    }
    ?>
    <?php
    $selected = "";

    foreach (_menus_locations_list() as $key => $mufl) {
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        include view("_menus_locations", "form_add")
        ?>
...
//$menu = (_menus_locations_details(1254)); 

//
//function _menus_create_menu_izq($location) {
//
//    $menus_items = _menus_list_by_location($location);
//
...
//    </a>';
//
//    foreach ($menus_items as $key => $item) {
//        echo '<a href="' . $item['url'] . '" class="list-group-item">' . icon($item['icon']) . ' ' . _tr($item['label']) . '</a>';
//    }
//
//    echo '</div>';
//}
//
//_menus_create_menu_izq('_menus_izq');
