...
<?php
if (isset($father_id) && _menus_list_childrens_from_father($father_id) ) {
    ...
    foreach (_menus_list_childrens_from_father($father_id) as $key => $mlblwf11) {
        ...
        $active = ( isset($father_id) && $id == $mlblwf11['id'] ) ? true : false;
        ...
        echo '<a href="index.php?c=_menus&a=search&w=by_father_id&id=' . $mlblwf11['id'] . '&father_id=' . $mlblwf11['father_id'] . '&location=' . $location . '&izq=child_of&" class="list-group-item ' . $class_active . '">' . $icon_mlblwf11 . ' ' . $mlblwf11['label'] . ' ' . $has_childrens . '</a> ';
        //
        //
        //
        //
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form method="post" action="index.php">
            ...
            <input type="hidden" name="redi[params]" value="<?php echo urldecode("w=by_father_id&father_id=$father_id&location=$location"); ?>">
