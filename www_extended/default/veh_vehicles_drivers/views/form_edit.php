...
# http://magiaphp.com 
# Fecha de creacion del documento: 2024-09-02 19:09:37 
#################################################################################
//vardump($veh_vehicles_drivers);
//vardump($veh_vehicles_drivers->getVehicle_id());
//            vardump($arg); 
?>
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <input type="hidden" name="driver_id" value="<?php echo $veh_vehicles_drivers->getDriver_id(); ?>">
    <input type="hidden" name="vehicle_id" value="<?php echo $veh_vehicles_drivers->getVehicle_id(); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input 
                ...
                disabled=""
                value="<?php echo veh_vehicles_field_id('name', $veh_vehicles_drivers->getVehicle_id()); ?>" >
             ...
             *  <select name="vehicle_id" class="form-control selectpicker" id="vehicle_id" data-live-search="true" disabled=""  >
              ...
              <?php
              foreach (veh_vehicles_drivers_list_by_driver_id($veh_vehicles_drivers->getDriver_id()) as $key => $vehicle_item) {

              $selected_vehicle = ($vehicle_item['vehicle_id'] == $veh_vehicles_drivers->getVehicle_id()) ? ' selected="" ' : '';

              echo '<option value="' . $vehicle_item['id'] . '">' . $vehicle_item['name'] . '</option>';
              }
              ?>
              </select>
             */
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="notes" class="form-control" id="notes" placeholder="" ><?php echo $veh_vehicles_drivers->getNotes(); ?></textarea>    <script>
                ClassicEditor
