<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input 
                ...
                id="code" 
                placeholder="code" 
                value="<?php echo $hr_payroll_lines->getCode(); ?>" 
                readonly=""
                >
        </div>	
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input 
                ...
                value="<?php echo $hr_payroll_lines->getQuantity(); ?>" >
        </div>	
    </div>
    <?php # /quantity ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <textarea name="formula" class="form-control" id="formula" ><?php echo $hr_payroll_lines->getFormula(); ?></textarea>
