...
$ids = (isset($_POST["ids"]) && $_POST["ids"] != "" && $_POST["ids"] != "null" ) ? clean($_POST["ids"]) : false;
...
if (!$error) {
    ...
    banks_lines_check_copy($ids_to_copy);

    switch ($redi["redi"]) {
        case 1:
            header("Location: index.php?c=banks_lines&a=search&w=by_status&status=1");
            break;
        ...
        default:
            header("Location: index.php?c=banks_lines&a=search&w=by_status&status=1#DEFAULT");
            break;
    }
} else {
