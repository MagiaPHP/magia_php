...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
               <select name="table_id" class="form-control selectpicker" id="table_id" data-live-search="true" >
                <?php magia_tables_select("id", array("id"), "" , array()); ?>                        
                </select>
        </div>	
    </div>
    <?php # /table_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="permission" class="form-control" id="permission" placeholder="permission" value="0000" >
        </div>	
    </div>
    <?php # /permission ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="align" class="form-control" id="align" placeholder="align" value="L" >
        </div>	
    </div>
    <?php # /align ?>
