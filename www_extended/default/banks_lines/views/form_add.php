...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="operation" class="form-control" id="operation" placeholder="operation" value=""  required="">
        </div>	
    </div>
    <?php # /operation ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="total" class="form-control" id="total" placeholder="total" value="" required="" >
        </div>	
    </div>
    <?php # /total ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="status_code" class="form-control selectpicker" id="status_code" data-live-search="true" >
                <?php banks_lines_status_select("code", "name", null, array(100)); ?>                                                                      
                <?php
//                foreach (banks_lines_status_list() as $key => $blsl) {
//
//                    if ($blsl['code'] != 100) {
//                        echo '<option valu="' . $blsl['code'] . '">' . _tr($blsl['name']) . '</option>';
//                    }
//                }
                ?>
