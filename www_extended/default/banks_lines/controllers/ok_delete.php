...
if (banks_lines_field_id('status', $id)) {
    array_push($error, "This status cannot be deleted");
}
###############################################################################
# CONDICIONAL
################################################################################
...
if (!$error) {
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=banks_lines&a=ok_delete&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
