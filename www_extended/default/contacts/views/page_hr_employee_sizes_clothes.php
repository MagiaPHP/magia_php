...
<div class="row">
    ...
    <div class="col-sm-7 col-md-7 col-lg-7">
        ...
        <h4>
            ...
            ?>
            <?php _t("Measurements of clothing"); ?>
        </h4>
        ...
        if ($hr_employee_sizes_clothes) {
            include "table_hr_employee_sizes_clothes.php";
        } else {
        ...
        <h4>
            ...
            ?>
            <?php _t("Work clothes delivery list"); ?>      
        </h4>
        ...
        <?php
        if ($hr_employee_sizes_clothes) {
            include "table_hr_employee_clothes.php";
        } else {
            message('info', 'No items');
        }
        ?>
    ...
    <div class="col-sm-3 col-md-3 col-lg-3">        
        <?php
        include "der_hr_employee_sizes_clothes.php";
        ?>                    
    </div>
