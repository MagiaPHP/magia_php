<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php?c=contacts&a=projects&id=<?php echo $id; ?>">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
                <li>
                    ...
                    if (modules_field_module('status', "docu")) {
                        echo docu_modal_bloc($c, $a, 'nav_invoices');
                    }
                    ?>
                </li>
            </ul>  
            ...
            <?php if (permissions_has_permission($u_rol, "projects", "creaxssssssssssssssssssste")) { ?>
                <button
                    type="button"
                    class="btn btn-primary navbar-btn navbar-right"
                    data-toggle="modal"
                    data-target="#contacts_projects_add"
                    >
                ...
                <div class="modal fade"
                     id="contacts_projects_add"
                     tabindex="-1"
                     role="dialog"
                     aria-labelledby="contacts_projects_addLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="contacts_projects_addLabel">
                                    <?php _t("Add new project"); ?>
                                </h4>
                            </div>
                            <div class="modal-body">
                                <?php //include "form_contacts_projects_add.php"; ?>
             ...
             *                 <div class="form-group">
              ...
              <?php
              foreach (project() as $key => $status_items) {
