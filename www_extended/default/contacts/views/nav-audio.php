<nav class="navbar navbar-default">
    <div class="container-fluid">        
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form action="index.php"  method="get" class="navbar-form navbar-left">
                ...
                <div class="form-group">
                    <input 
                        ...
                        type="text" 
                        class="form-control" 
                        placeholder="<?php _t("Name"); ?>, <?php _t('Lastname'); ?>" 
                        autofocus
                        required=""
                        >
                </div>
                ...
                <div class="form-group">
                    <select class="form-control" name="w">
                        <option value="all" <?php echo (isset($w) && $w == "all") ? " selected " : ""; ?>><?php echo _t("All"); ?></option>
                        <option value="headoffice" <?php echo (isset($w) && $w == "headoffice") ? " selected " : ""; ?>><?php echo _t("Head Offices"); ?></option>
                        <option value="headofficeandoffices" <?php echo (isset($w) && $w == "headofficeandoffices") ? " selected " : ""; ?>><?php echo _t("Head Offices and offices"); ?></option>
                        <option value="contacts" <?php echo (isset($w) && $w == "contacts") ? " selected " : ""; ?>><?php echo _t("Contacts"); ?></option>
                    </select>
                </div> 
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="index.php?c=contacts&a=search&w=billing_method&bm=M"><?php _t("Monthly billing"); ?></a></li>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <?php
                //vardump(permissions_has_permission($u_rol, "contacts", "create"));
