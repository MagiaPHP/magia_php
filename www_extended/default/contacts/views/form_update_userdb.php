<form class="form-horizontal" method="post" action="index.php">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="name"><?php _t("User DB"); ?></label>	
        ...
        <div class="col-sm-6">    
            ...
            <span id="status" class="help-block">
                <a href="https://server.coello.be:2083/cpsess0559602951/frontend/paper_lantern/sql/index.html#mysqlusers" target="_new">
