    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                <span class="sr-only">Toggle navigation contacts</span>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <?php
            if (IS_MULTI_VAT && false) {
                include view("contacts", "form_search_simple_multi");
                //include "form_search_simple_multi.php";
            } else {
                include view("contacts", "form_search_simple");
                //include "form_search_simple.php";
            }
            ?>


            <?php // include view("contacts", "form_search"   , $arg = ["redi" => 1]) ?>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php
                                        include view("contacts", "form_show_col_from_table");
                                        ?>
                ...
                if (
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="index.php?c=contacts&a=export_json"><?php _t("Json"); ?></a></li>
                            <li><a href="index.php?c=contacts&a=export_pdf"><?php _t("Pdf"); ?></a></li>
                            <li><a href="index.php?c=contacts&a=export_csv"><?php _t("CSV"); ?></a></li>
                            <li><a href="index.php?c=contacts&a=export_xml"><?php _t("XML"); ?></a></li>
            ...
            $menu_items = _menus_list_by_location_without_father("contacts_nav");
            ?>
                ...
                <?php if (!empty($menu_items)): ?>
                    <?php foreach ($menu_items as $item): ?>
                        <?php if (_menus_can_show($item["controller"])): ?>
                            <li>
                                <?= _menus_dropdown_create_html("contacts_nav", $item); ?>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php else: ?>
            ...
            /**
              <ul class="nav navbar-nav">
              <li><a href="index.php?c=contacts&a=search_advanced"><?php _t("Search avanced"); ?></a></li>
            ...
            <div class="collapse navbar-collapse" id="contacts_add">
                ...
                <?php if (permissions_has_permission($u_rol, "contacts", "create")) { ?>    
                    <a type="button" href="index.php?c=contacts&a=add" class="btn btn-primary navbar-btn navbar-right">
                ...
                <?php if (permissions_has_permission($u_rol, "contacts", "create") && 2 == 1 ) { ?>     

                    <button type="button" class="btn btn-primary navbar-btn navbar-right" data-toggle="modal" data-target="#contactsModal">
                        <span class="glyphicon glyphicon-plus-sign"></span>
                        <?php _t("New contacts"); ?>
                    </button>
