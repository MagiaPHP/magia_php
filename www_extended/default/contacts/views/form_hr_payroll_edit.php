<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="employee_id" class="form-control selectpicker" id="employee_id" data-live-search="true" >
                <?php employees_select("id", array("id"), $hr_payroll->getEmployee_id(), array()); ?>                        
            </select>
        </div>	
    </div>
    <?php # /employee_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="notes" class="form-control" id="notes" placeholder="" ><?php echo $hr_payroll->getNotes(); ?></textarea>    
