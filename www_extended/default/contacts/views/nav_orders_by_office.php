    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php?c=contacts&a=orders&id=<?php echo $id; ?>">
                ...
                <?php echo ( _options_option('config_menus_debug') ) ? _menus_get_file_name(__FILE__) : _t("Orders by offices"); ?>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form class="navbar-form navbar-right" method="get" action="index.php">
                ...
                <div class="form-group">
                    <select class="form-control" name="status">
                        <option value="all"><?php _t("All"); ?> (<?php echo orders_total_by_office_id($id); ?>)</option>
                        ...
                        foreach (orders_status_list() as $key => $status_items) {
                            ...
                            $total = orders_total_by_office_id_status($id, $status_items['code']);
                            ?>
