...
<div class="list-group">
    ...
    <?php if (permissions_has_permission($u_rol, "contacts", "read")) { ?>
        <a href="index.php?c=contacts&a=contacts&id=<?php echo "$id"; ?>" class="list-group-item <?php echo ($a == 'contacts') ? "list-group-item-info" : ""; ?>">
            <?php _menu_icon("top", "contacts"); ?>
            <?php _t("Contacts"); ?>
        </a>
    <?php } ?>
    ...
    <?php if (permissions_has_permission($u_rol, "contacts", "read") && false) { ?>
    ...
    <?php //if (permissions_has_permission($u_rol, "banks", "read") && contacts_is_headoffice($id) && modules_field_module('status', modules_field_module('father', 'banks'))) { ?>
    ...
    <?php if (permissions_has_permission($u_rol, "projects", "read") && modules_field_module('status', 'projects') && false) { ?>
