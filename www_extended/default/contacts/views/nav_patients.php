<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php?c=contacts&a=patients&id=<?php echo $id; ?>">
                <?php _menu_icon("top", "patients"); ?>
                <?php echo contacts_formated(offices_headoffice_of_office($id)); ?> >
                <?php echo contacts_formated($id); ?> > 
                <?php echo ( _options_option('config_menus_debug') ) ? _menus_get_file_name(__FILE__) : _t("Patients"); ?>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <?php if (permissions_has_permission($u_rol, "contactsxxxx", "create")) { ?>   
                <button 
                    type="button" 
