...
if (!permissions_has_permission($u_rol, "hr_employee_benefits", "read")) {
...
//    ################################################################################
//    $pagination = new Pagination($page, hr_employee_benefits_by_employee_id($id));
//    // puede hacer falta
//    $url = "index.php?c=hr_employee_benefits&a=search&w=by_employee_id&employee_id=" . $id;
//    $pagination->setUrl($url);
//    $hr_employee_benefits = hr_employee_benefits_by_employee_id($id, $pagination->getStart(), $pagination->getLimit());
//    ################################################################################ 
    //vardump($hr_employee_benefits); 
    ...
    $hr_employee_benefits = hr_employee_benefits_by_employee_id($id);

    include view("contacts", "page_hr_employee_benefits");
    //
    //
    //
    //
