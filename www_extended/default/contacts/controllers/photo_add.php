...
$MAX_FILE_SIZE = (isset($_POST['MAX_FILE_SIZE'])) ? clean($_POST['MAX_FILE_SIZE']) : false;
...
class imgUpldr {
    ...
    private $_dest = "www/gallery/img/contacts/";
    private $_img;
    private $_ext;
    private $_r = "";
    ...
    public function updateDB($id) {
        ...
        contacts_photos_add($id, $this->_name);
        // contacts_add_photo($id, "robin");
    }
}
