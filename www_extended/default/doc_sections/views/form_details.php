<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="section" class="form-control" id="section" placeholder="section" value="<?php echo $doc_sections['section']; ?>"  disabled="" >
        </div>	
    </div>
    <?php # /section ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $doc_sections['order_by']; ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
