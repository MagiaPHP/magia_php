...
//
$SetFont = (isset($_POST["SetFont"])) ? clean($_POST["SetFont"]) : false;
$SetTextColor = (isset($_POST["SetTextColor"])) ? clean($_POST["SetTextColor"]) : false;
$SetDrawColor = (isset($_POST["SetDrawColor"])) ? clean($_POST["SetDrawColor"]) : false;
$SetFillColor = (isset($_POST["SetFillColor"])) ? clean($_POST["SetFillColor"]) : false;
//
...
//
//
$hidden = (isset($_POST["hidden"]) && $_POST["hidden"] != "") ? clean($_POST["hidden"]) : false;
