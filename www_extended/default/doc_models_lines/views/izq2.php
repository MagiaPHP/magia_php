...
<div class="list-group">
    ...
    <?php if (_options_option('config_pdf_debug')) { ?>
        <a class="list-group-item" href="index.php?c=config&a=ok_pdf_debug&data=0&redi[redi]=2&redi[modele]=<?php echo $modele; ?>"><?php _t("Debug mode off"); ?></a>

    <?php } else { ?>
        <a class="list-group-item" href="index.php?c=config&a=ok_pdf_debug&data=1&redi[redi]=2&redi[modele]=<?php echo $modele; ?>"><?php _t("Debug mode on"); ?></a>
    <?php }
    ?>
    ...
    if (_options_option('config_debug_number_line')) {
        ?>
        <a class="list-group-item"  href="index.php?c=config&a=ok_pdf_debug_number_line&data=0&redi[redi]=2&redi[modele]=<?php echo $modele; ?>"><?php _t("Hidden number lines"); ?></a>

    <?php } else { ?>
        <a class="list-group-item"  href="index.php?c=config&a=ok_pdf_debug_number_line&data=1&redi[redi]=2&redi[modele]=<?php echo $modele; ?>"><?php _t("Show number lines"); ?></a>
    <?php }
    ?>
