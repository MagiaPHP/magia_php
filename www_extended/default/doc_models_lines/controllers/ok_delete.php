...
if (!$error) {
    ...
    switch ($redi["redi"]) {
        ...
        case 3:
            header("Location: index.php?c=doc_models_lines&a=search&modele=a&=invoices#ok3 ");
            break;

        case 4:
            header("Location: index.php?c=doc_models_lines&a=search&modele=" . $redi["modele"] . "&doc=" . $redi["doc"] . "#ok4");
            break;
