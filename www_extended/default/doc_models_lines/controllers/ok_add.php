...
$label = (isset($_REQUEST["label"]) && $_REQUEST["label"] != "" && $_REQUEST["label"] != "null" ) ? clean($_REQUEST["label"]) : null;

$p = '{"SetFont":{"font":"Arial","format":{"R":"R"},"fontsize":"10"},"Cell":{"label":"' . $label . '","x":"","y":"","w":"50","h":"5","border":{"L":"L","R":"R","B":"B","T":"T"},"ln":"1","align":"C","link":""},"SetTextColor":{"r":"","g":"","b":""},"SetDrawColor":{"r":"","g":"","b":""},"SetFillColor":{"r":"","g":"","b":""},"AddPage":false,"Line":{"x1":10,"y1":20,"x2":100,"y2":100},"hidden":false}';
...
if (!$error) {
    ...
    switch ($redi) {
        ...
        case 3:
            header("Location: index.php?c=doc_models_lines&a=edit&id=$lastInsertId");
            break;
