...
# FORMAT
################################################################################
if (!hr_employee_sizes_clothes_is_id($id)) {
    array_push($error, 'Id format error');
}
###############################################################################
# CONDICIONAL
################################################################################
// no puede borrar esta vestimenta ya que se encuentra en la lista de prendas entregadas a este trabajador
//if() {
//    array_push($error, "Id is mandatory");
//}
################################################################################
...
if (!$error) {
    ...
    hr_employee_sizes_clothes_delete(
            $id
    );
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_employee_sizes_clothes&a=ok_delete&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
