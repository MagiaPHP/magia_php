<a href="" data-toggle="modal" data-target="#modal_total_sold_update_<?php echo $wd->getId(); ?>">
    <?php echo moneda($total_sold ?? 0); ?>    
</a>

<div class="modal fade" id="modal_total_sold_update_<?php echo $wd->getId(); ?>" 
     tabindex="-1" role="dialog" aria-labelledby="modal_total_sold_update_<?php echo $wd->getId(); ?>Label">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modal_total_sold_update_<?php echo $wd->getId(); ?>Label">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="index.php">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="formule" rows="5"><?php echo $formule_total_sold; ?></textarea>                                             
                    </div>
