...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <div class="row">
                <div class="col-xs-2">
                    <label class="control-label col-sm-4" for="start_pm"><?php _t("Start am"); ?></label>
                    <select class="form-control" name="start_pm">
                        <?php
                        for ($start_pm_h = 1; $start_pm_h < 24; $start_pm_h++) {
                            for ($start_pm_m = 0; $start_pm_m < 60; $start_pm_m = $start_pm_m + 15) {
                                echo '<option value="' . $start_pm_h . '">' . $start_pm_h . ' h ' . $start_pm_m . '</option>';
                            }
                        }
                        ?>
                    </select>
                ...
                <div class="col-xs-2">
                    <label class="control-label col-sm-3" for="start_pm"><?php _t("End am"); ?></label>
                    <select class="form-control" name="start_pm">
                        <?php
                        for ($start_pm_h = 1; $start_pm_h < 24; $start_pm_h++) {
                            for ($start_pm_m = 0; $start_pm_m < 60; $start_pm_m = $start_pm_m + 15) {
                ...
                <div class="col-xs-2">
                    <label class="control-label col-sm-3" for="start_pm"><?php _t("Lunch time"); ?></label>
                    <select class="form-control" name="start_pm">
                        <?php
                        for ($lunch = 0; $lunch < 61; $lunch = $lunch + 15) {
                            echo '<option value="' . $lunch . '">' . $lunch . ' min</option>';
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="col-xs-2">
                    <label class="control-label col-sm-3" for="start_pm"><?php _t("Start pm"); ?></label>
                    <select class="form-control" name="start_pm">
                        <?php
                        for ($start_pm_h = 1; $start_pm_h < 24; $start_pm_h++) {
                            for ($start_pm_m = 0; $start_pm_m < 60; $start_pm_m = $start_pm_m + 15) {
                ...
                <div class="col-xs-2">
                    <label class="control-label col-sm-3" for="start_pm"><?php _t("End pm"); ?></label>
                    <select class="form-control" name="start_pm">
                        <?php
                        for ($start_pm_h = 1; $start_pm_h < 24; $start_pm_h++) {
                            for ($start_pm_m = 0; $start_pm_m < 60; $start_pm_m = $start_pm_m + 15) {
