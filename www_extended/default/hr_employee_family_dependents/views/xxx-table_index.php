...
<?php //Creation date:  2024-06-03 02:06:34            ?>
...
<?php
if (_options_option("config_hr_employee_family_dependents_show_col_from_table")) {
    $colsToShow = json_decode(_options_option("config_hr_employee_family_dependents_show_col_from_table"), true);
...
//            $checked_array = json_decode(_options_option("config_hr_employee_family_dependents_show_col_from_table"), true);
//            foreach (hr_employee_family_dependents_db_col_list_from_table($c) as $th) {
...
//                    echo '<th><a href="index.php?c=hr_employee_family_dependents&order_col=' . $th . '' . $link_order_way . ' ">' . _tr(ucfirst($th)) . ' ' . $order_icon_show . '</a></th>';
//                }
//                $order_icon_show = false;
//            }
            ?>                                
            <?php hr_employee_family_dependents_index_generate_column_headers($cols_to_show_keys); ?>
...
//            }
    ...
    <tbody>
        <tr>
            <?php
            if (!$hr_employee_family_dependents) {
            ...
            foreach ($hr_employee_family_dependents as $hr_employee_family_dependents_item) {
                $menu = '<div class="dropdown">
                            ...
                            <?php if (permissions_has_permission($u_rol, "hr_employee_family_dependents", "read")) { ?>
                              <li><a href="index.php?c=hr_employee_family_dependents&a=details&id=' . $hr_employee_family_dependents_item["id"] . '">' . _tr("Details") . '</a></li>
                            <?php } ?>
                            
                            <?php if (permissions_has_permission($u_rol, "hr_employee_family_dependents", "update")) { ?>
                                <li><a href="index.php?c=hr_employee_family_dependents&a=edit&id=' . $hr_employee_family_dependents_item["id"] . '">' . _tr("Edit") . '</a></li>
                            <?php } ?>    

                             <?php if (permissions_has_permission($u_rol, "hr_employee_family_dependents", "delete")) { ?>
                              <li role="separator" class="divider"></li>                              
                              <li><a href="index.php?c=hr_employee_family_dependents&a=delete&id=' . $hr_employee_family_dependents_item["id"] . '">' . _tr("Delete") . '</a></li>
                            <?php } ?>    
                            

                            </ul>
                          </div>';
                //     echo "<tr id=\"$hr_employee_family_dependents_item[id]\">";
                // $checked_array = json_decode(_options_option("config_hr_employee_family_dependents_show_col_from_table"), true);
//                foreach (hr_employee_family_dependents_db_col_list_from_table($c) as $col_name) {
//                    if (isset($checked_array[$col_name]) || !isset($checked_array)) {
//                        //echo "<td>$hr_employee_family_dependents_item[$col_name]</td>";
//                            
//                        // si una columna se llama xx
//                        if ($col_name == "xxxxxxxxxxxxxx") { // se pone un filtro en este caso la primera mayuscula
//                            echo "<td>" . hr_employee_family_dependents_add_filter($col_name, $hr_employee_family_dependents_item[$col_name], ucfirst($col_name)) . "</td>";
//                        } else {
//                            echo "<td>" . hr_employee_family_dependents_add_filter($col_name, $hr_employee_family_dependents_item[$col_name]) . "</td>";
//                        }                                                
//                    }
//                }                echo "<td>$menu</td>";
                echo "</tr>";

                //hr_employee_family_dependents_index_generate_column_body_td($hr_employee_family_dependents_item, $colsToShow);
    ...
    <?php include view("hr_employee_family_dependents", "table_index_form_add"); ?>
