<?php
// paso las variables a Oriente objet
?>

<form class="form-horizontal" action="index.php" method="get" >
    <input type="hidden" name="c" value="investments">
    <input type="hidden" name="a" value="edit">
    <input type="hidden" name="id" value="<?php echo $investments->getId(); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="institution_id" class="form-control selectpicker" id="institution_id" data-live-search="true"  disabled="" >
                <?php contacts_select("id", "id", $investments->getInstitution_id(), array()); ?>                        
            </select>
        </div>	
    </div>
    <?php # /institution_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input 
                ...
                class="form-control" 
                id="type" 
                placeholder="type" value="<?php echo $investments->getType(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /type ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input 
                ...
                class="form-control" 
                id="operation" 
                placeholder="operation" value="<?php echo $investments->getOperation(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /operation ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="ref" class="form-control" id="ref" placeholder="ref" 
                   value="<?php echo $investments->getRef(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /ref ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="amount" class="form-control" id="amount" placeholder="amount" 
                   value="<?php echo $investments->getAmount(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /amount ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="days" class="form-control" id="days" placeholder="days" 
                   value="<?php echo $investments->getDays(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /days ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="rate" class="form-control" id="rate" placeholder="rate" 
                   value="<?php echo $investments->getRate(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /rate ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="total" class="form-control" id="total" placeholder="total" 
                   value="<?php echo $investments->getTotal(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /total ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="retention" class="form-control" id="retention"
                   placeholder="retention" value="<?php echo $investments->getRetention(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /retention ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_start" class="form-control" id="date_start" 
                   placeholder="date_start" value="<?php echo $investments->getDate_start(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /date_start ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_end" class="form-control"
                   id="date_end" placeholder="date_end" value="<?php echo $investments->getDate_end(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /date_end ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control"
                   id="order_by" placeholder="order_by" value="<?php echo $investments->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="status" class="form-control" id="status"  disabled="" >                
                <option value="1" <?php echo ($investments->getStatus() == 1 ) ? " selected " : ""; ?> ><?php echo _t("Actived"); ?></option>
                <option value="0" <?php echo ($investments->getStatus() == 0 ) ? " selected " : ""; ?> ><?php echo _t("Blocked"); ?></option>
            </select>
        </div>	
    </div>
    <?php # /status ?>
