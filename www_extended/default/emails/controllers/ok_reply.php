...
// id del email en cuestion
// q sera el padre
$id = (isset($_POST["id"]) && $_POST["id"] != "" && $_POST["id"] != "null" ) ? clean($_POST["id"]) : null;
//$redi = (isset($_POST["redi"]) && $_POST["redi"] != "" && $_POST["redi"] != "null" ) ? clean($_POST["redi"]) : null;

$father_id = $id;
$sender_id = $u_id;
$reciver_id = emails_field_id('reciver_id', $id);
$folder = null;
$subjet = null;
...
################################################################################
//vardump(
//        array($father_id, $sender_id, $reciver_id, $folder, $subjet, $message, $date_registre, $date_read, $order_by, $status)
//);
//
//die();
...
//    );
    ...
    switch ($redi[redi]) {
        ...
        case 3:
            header("Location: index.php?c=$redi[c]&a=$redi[a]&id=$id");
            break;
        ...
        case 5:
            header("Location: index.php?c=emails&a=sent&id=$id");
            break;
