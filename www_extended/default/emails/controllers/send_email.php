...
////Email
//$config_mail_host = "mail.web.com";
//$config_mail_username = "cloud@web.com";
//$config_mail_password = 'fA)6ZUZ!F#A8';
...
try {
    ...
    //$mail->addAddress('rc@web.com') ;               // Name is optional
    $mail->addReplyTo($config_company_email, $config_company_name); // responder a 
//    $mail->addBCC('cloud@web.com');
