<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">                    
            <input 
                ...
                value="<?php echo "$doc_translations[language]"; ?>" 
                disabled=""
                >
        </div>	
    </div>
    ...
    <?php # body ?>
    <div class="form-group">
        <label class="control-label col-sm-2" for="summernote"><?php _t("Body"); ?></label>
        <div class="col-sm-8">                    
            <textarea id="summernote" name="body" class="form-control" ><?php echo "$doc_translations[body]"; ?></textarea>
            <script>
