...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="json" class="form-control" id="json" placeholder="json - textarea" ></textarea>
        </div>	
    </div>
    <?php # /json ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="pdf_base64" class="form-control" id="pdf_base64" placeholder="pdf_base64 - textarea" ></textarea>
        </div>	
    </div>
    <?php # /pdf_base64 ?>
