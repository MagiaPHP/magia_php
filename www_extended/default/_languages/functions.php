...
function _languages_get_default_system_language() {
...
function _languages_list_languages() {
    global $db;
    $req = $db->prepare("SELECT `language` FROM _languages");
    $req->execute(array());
...
//    // saco la lista de lenguaes en un array 
//    // si lo que mando no esta en esea lista 
//    // manda error 
//
//    $languages_array = _languages_list_languages();
//
