...
# http://magiaphp.com 
# Fecha de creacion del documento: 2024-09-03 13:09:32 
#################################################################################
?>
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="action" class="form-control" id="action" placeholder="action"  required=""  value="<?php echo $panels->getAction(); ?>" >
        </div>	
    </div>
    <?php # /action ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="name" class="form-control" id="name" placeholder="name"  required=""  value="<?php echo $panels->getName(); ?>" >
        </div>	
    </div>
    <?php # /name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="panel" class="form-control" id="panel" placeholder="panel"  required=""  value="<?php echo $panels->getPanel(); ?>" >
        </div>	
    </div>
    <?php # /panel ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by"   required=""  value="<?php echo $panels->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
