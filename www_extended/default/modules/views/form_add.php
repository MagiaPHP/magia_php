...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="label" class="form-control" id="label" placeholder="label" 
                   value="<?php echo (isset($module) && $module ) ? $module : ''; ?>" 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="module" class="form-control" id="module" placeholder="module" 
                   value="<?php echo (isset($module) && $module ) ? $module : ''; ?>" 
                   >
        </div>	
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="description" class="form-control" id="description" placeholder="description - textarea" ><?php echo (isset($module) && $module ) ? $module : ''; ?></textarea>
        </div>	
    </div>
    <?php # /description  ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="author_email" class="form-control" id="author_email" placeholder="author_email" 
                   value="robincoello#hotmail.com" >
        </div>	
    </div>
    <?php # /author_email  ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="url" class="form-control" id="url" placeholder="url" value="https://coello.be" >
        </div>	
    </div>
    <?php # /url  ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="version" class="form-control" id="version" placeholder="version" value="1" >
        </div>	
    </div>
    <?php # /version  ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="status" class="form-control" id="status" >                
                <option value="1" selected=""><?php echo _t("Actived"); ?></option>
