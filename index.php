...
//
//
// Inicia el temporizador al principio del script
...
include "www_extended/default/contacts/models/Company.php";
//
...
//// esto es para el order_by de cada usuario en diferentes paginas y tablas 
//$order_col = clean($_GET["order_col"] ?? "id");  // Si no se especifica, por defecto "id"
//$order_way = clean($_GET["order_way"] ?? "desc"); // Si no se especifica, por defecto "desc"
#########################################################################
...
// Termina el temporizador al final del script
$end_time = microtime(true);

// Calcula el tiempo de ejecución
$execution_time = $end_time - $start_time;

// Formatea el tiempo de ejecución a milisegundos
$execution_time_ms = $execution_time * 1000; // en milisegundos
//
// Registro del tiempo de ejecución en el archivo de logs
log_execution_time($execution_time_ms, $c, $a);
