...
function campos_crear_campo($tipo, $nombre, $id, $clase = "form-control", $marca_agua = false, $valor = false, $desactivo = false, $columna = null) {
    global $plugin;
    $tabla_externa = '';
    $columna_externa = '';

    $is_null = ($columna['Null'] == 'YES') ? true : false; // 

    $required = ($columna['Null'] == 'NO') ? ' required="" ' : false; // 
...
////////////////////////////////////////////////////////////////////////////////
            switch ($nombre) {
                ...
                case 'registred_by':
                    $campo = '<select name="' . $nombre . '" class="' . $clase . ' selectpicker" id="' . $id . '" data-live-search="true" ' . $disabled . '>
                <?php ' . $tabla_externa . '_select("' . $columna_externa . '", array("name", "lastname"), ' . $valor . ' , array($u_id)); ?>                        
                </select>';
                    break;

                case 'vehicle_id':
                    $campo = '<select name="' . $nombre . '" class="' . $clase . ' selectpicker" id="' . $id . '" data-live-search="true" ' . $disabled . '>
                <?php ' . $tabla_externa . '_select("' . $columna_externa . '", array("name"), ' . $valor . ' , array()); ?>                        
                </select>';
                    break;
                ...
                ' . $tabla_externa . '_select("' . $columna_externa . '", array("' . $columna_externa . '"), ' . $valor . ' , array()); ?>                        
                </select>';
...
////////////////////////////////////////////////////////////////////////////////
        ...
        case 'int':
        case 'number':
            $campo = '<input type="number" step="any" name="' . $nombre . '" class="' . $clase . '" id="' . $id . '" placeholder="' . $marca_agua . '"  ' . $required . ' value="' . $valor . '" ' . $disabled . '>';

            break;

        case 'date':
            $campo = '<input type="date" name="' . $nombre . '" class="' . $clase . '" id="' . $id . '" placeholder="' . $marca_agua . '" ' . $required . ' value="' . $valor . '" ' . $disabled . '>';
            break;
        ...
        case 'timestamp':
            $campo = '<input 
                ...
                class="' . $clase . '" 
                id="' . $id . '" 
                placeholder="' . $marca_agua . '" ' . $required . ' 
                value="' . $valor . '" 
                ' . $disabled . '>';
            break;
        ...
        default:
            $campo = '<input type="text" name="' . $nombre . '" class="' . $clase . '" id="' . $id . '" placeholder="' . $marca_agua . '" ' . $required . ' value="' . $valor . '" ' . $disabled . '>';
            break;
    }
